...
`lastip` varchar(16) default '' COMMENT '最近登陆ip',
...
`huifuid` varchar(50) default '' COMMENT '汇付用户ID',
`create_time` datetime NOT NULL COMMENT '注册时间',
...
`userid` int(11) unsigned NOT NULL COMMENT '用户id',
`type` tinyint(3) unsigned NOT NULL COMMENT '第三方登录类型 1:qq, 2:weibo, 3:weixin',
