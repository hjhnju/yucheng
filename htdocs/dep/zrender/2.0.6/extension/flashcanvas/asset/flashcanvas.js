        ...
        CanvasRenderingContext2D.prototype = {
            ...
            _setStrokeStyle: function () {
                if (this._strokeStyle !== this.strokeStyle) {
                    ...
                    } else if (style instanceof CanvasGradient || style instanceof CanvasPattern) {
                        style = style.id;
                    } else {
                        return;
                    }
            ...
            createPattern: function (image, repetition) {
                ...
                if (!(repetition === 'repeat' || repetition === 'no-repeat' || repetition === 'repeat-x' || repetition === 'repeat-y' || repetition === '' || repetition === NULL)) {
            ...
            fillText: function (text, x, y, maxWidth) {
                ...
                this._setShadows();
                this._setFontStyles();
                this._queue.push(properties.fillText, encodeXML(text), x, y, maxWidth === undefined ? Infinity : maxWidth);
            },
            strokeText: function (text, x, y, maxWidth) {
                ...
                this._setShadows();
                this._setFontStyles();
                this._queue.push(properties.strokeText, encodeXML(text), x, y, maxWidth === undefined ? Infinity : maxWidth);
            },
            ...
            _executeCommand: function () {
                ...
                if (commands.length > 0) {
                    return eval(this._swf.CallFunction('<invoke name="executeCommand" returntype="javascript"><arguments><string>' + commands.join('&#0;') + '</string></arguments></invoke>'));
                }
            },
                ...
                initElement: function (canvas) {
                    ...
                    canvas.toDataURL = function (type, quality) {
                        if (('' + type).replace(/[A-Z]+/g, toLowerCase) === 'image/jpeg') {
                            ctx._queue.push(properties.toDataURL, type, typeof quality === 'number' ? quality : '');
                        } else {
