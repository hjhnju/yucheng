        ...
        var $ = function () {
                ...
                (function () {
                    ...
                    function C(a, d) {
                        function h(a) {
                            for (var l = a.e, j = [
                                        l,
                                        'pln'
                                    ], c = 0, p = a.a.match(e) || [], m = {}, q = 0, f = p.length; q < f; ++q) {
                    ...
                    function t(a) {
                        ...
                        a.verbatimStrings && h.push([
                            'str',
                            /^@"(?:[^"]|"")*(?:"|$)/,
                            r
                        ]);
                        var b = a.hashComments;
                        b && (a.cStyleComments ? (b > 1 ? d.push([
                            'com',
                            /^#(?:##(?:[^#]|#(?!##))*(?:###|$)|.*)/,
                            r,
                            '#'
                        ...
                        if (b = a.regexLiterals) {
                            ...
                            h.push([
                                'lang-regex',
                                RegExp('^(?:^^\\.?|[+-]|[!=]=?=?|\\#|%=?|&&?=?|\\(|\\*=?|[+\\-]=|->|\\/=?|::?|<<?=?|>>?>?=?|,|;|\\?|@|\\[|~|{|\\^\\^?=?|\\|\\|?=?|break|case|continue|delete|do|else|finally|instanceof|return|throw|try|typeof)\\s*(' + ('/(?=[^/*' + b + '])(?:[^/\\x5B\\x5C' + b + ']|\\x5C' + e + '|\\x5B(?:[^\\x5C\\x5D' + b + ']|\\x5C' + e + ')*(?:\\x5D|$))+/') + ')')
                            ]);
                        }
                        (b = a.types) && h.push([
                            'typ',
                    ...
                    function z(a, d, h) {
                        ...
                        for (var d = Math.max(0, d - 1 | 0) || 0, p = 0, q = c.length; p < q; ++p)
                            i = c[p], i.className = 'L' + (p + d) % 10, i.firstChild || i.appendChild(l.createTextNode('\xA0')), n.appendChild(i);
                        a.appendChild(n);
                    }
                    function i(a, d) {
                    ...
                    function D(a) {
                        ...
                        try {
                            ...
                            try {
                                for (; b < n;) {
                                    var o = l[b + 2] || j, H = c[t + 2] || j, u = Math.min(o, H), E = l[b + 1], W;
                    ...
                    var V = window, G = ['break,continue,do,else,for,if,return,while'], O = [
                        ...
                        ], Q = /^(DIR|FILE|vector|(de|priority_)?queue|list|stack|(const_)?iterator|(multi)?(set|map)|bitset|u?(int|float)\d*)\b/, S = /\S/, T = t({
                            keywords: [
                                J,
                                L,
                                O,
