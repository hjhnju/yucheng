! function(e, t) {
    ...
    if (lt.fn.extend({
            ...
            get: function(e, n) {
                var i = lt.prop(e, n),
                    ...
                    o = "boolean" == typeof i ? It && Ot ? null != r : Lt.test(n) ? e[lt.camelCase("default-" + n)] : !!r : e.getAttributeNode(n);
                return o && o.value !== !1 ? n.toLowerCase() : t
            },
            set: function(e, t, n) {
                if (t === !1) lt.removeAttr(e, n);
                else if (It && Ot || !Lt.test(n)) e.setAttribute(!Ot && lt.propFix[n] || n, n);
                else e[lt.camelCase("default-" + n)] = e[n] = !0;
                return n
            }
        }, !It || !Ot) lt.attrHooks.value = {
        get: function(e, n) {
    ...
    if (!lt.support.changeBubbles) lt.event.special.change = {
        setup: function() {
            ...
            lt.event.add(this, "beforeactivate._change", function(e) {
                var t = e.target;
                if (Rt.test(t.nodeName) && !lt._data(t, "changeBubbles")) lt.event.add(t, "change._change", function(e) {
    ...
    lt.fn.extend({
        ...
        function(e, t) {
            ...
            function w() {}
            var T, E, C, _, k, N, S, D, A, M, j, L, O, I, R, H, q, P = "sizzle" + -new Date,
                F = e.document,
                $ = {},
                B = 0,
                W = 0,
            ...
            k = s.isXML = function(e) {
                ...
                if (C.find.TAG = $.tagNameNoComments ? function(e, t) {
                    ...
                    }, I = [], O = [":focus"], $.qsa = n(i.querySelectorAll)) o(function(e) {
                ...
                if ($.matchesSelector = n(R = j.matchesSelector || j.mozMatchesSelector || j.webkitMatchesSelector || j.oMatchesSelector || j.msMatchesSelector)) o(function(e) {
                    $.disconnectedMatch = R.call(e, "div"), R.call(e, "[s!='']:x"), I.push("!=", ot)
                });
                return O = new RegExp(O.join("|")), I = new RegExp(I.join("|")), H = n(j.contains) || j.compareDocumentPosition ? function(e, t) {
                ...
                if (t = t.replace(bt, "='$1']"), !(!$.matchesSelector || L || I && I.test(t) || O.test(t))) try {
                    var n = R.call(e, t);
    ...
    Mn = $n.exec(jn.toLowerCase()) || [], lt.fn.load = function(e, n, i) {
        ...
        ajax: function(e, n) {
            ...
            if (m.promise(T).complete = g.add, T.success = T.done, T.error = T.fail, p.url = ((e || p.url || jn) + "").replace(In, "").replace(Fn, Mn[1] + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = lt.trim(p.dataType || "*").toLowerCase().match(ft) || [""], null == p.crossDomain) r = $n.exec(p.url.toLowerCase()), p.crossDomain = !(!r || r[1] === Mn[1] && r[2] === Mn[2] && (r[3] || ("http:" === r[1] ? 80 : 443)) == (Mn[3] || ("http:" === Mn[1] ? 80 : 443)));
            ...
            if (p.type = p.type.toUpperCase(), p.hasContent = !Pn.test(p.type), s = p.url, !p.hasContent) {
                ...
                if (p.cache === !1) p.url = Rn.test(s) ? s.replace(Rn, "$1_=" + Ln++) : s + (On.test(s) ? "&" : "?") + "_=" + Ln++
            }
            if (p.ifModified) {
    ...
    function(e) {
        ...
        var D = 178245,
            ...
            O = ";",
            I = "return r;";
        if ("undefined" != typeof navigator && /msie\s*([0-9]+)/i.test(navigator.userAgent) && RegExp.$1 - 0 < 8) j = "var r=[],ri=0;", L = "r[ri++]=", I = 'return r.join("");';
        p.prototype = {
        ...
        var R = 'data=data||{};var v={},fs=engine.filters,hg=typeof data.get=="function",gv=function(n,ps){var p=ps[0],d=v[p];if(d==null){if(hg){return data.get(n);}d=data[p];}for(var i=1,l=ps.length;i<l;i++)if(d!=null)d = d[ps[i]];return d;},ts=function(s){if(typeof s==="string"){return s;}if(s==null){s="";}return ""+s;};';
        ...
        y.prototype.applyMaster = m.prototype.applyMaster = function(e) {
            ...
            if (this.isReady()) {
                var e = new Function("data", "engine", [R, j, this.getRendererBody(), I].join("\n")),
                    t = this.engine;
            ...
            h(e), d.prototype.open.call(this, e), this.state = H.READING, _(this, e)
            ...
            var e = this.args;
            return l("{2}fs[{5}]((function(){{0}{4}{1}})(){6}){3}", j, I, L, O, d.prototype.getRendererBody.call(this), s(this.name), e ? "," + c(e, this.engine) : "")
        };
        var q = {};
        ...
        (function(e) {
            ...
            for (var ct, pt, dt = "2.7.0", ht = ("undefined" != typeof global ? global : this, Math.round), mt = 0, gt = 1, yt = 2, vt = 3, bt = 4, xt = 5, wt = 6, Tt = {}, Et = {
                    ...
                    _pf: null,
                    _lang: null
                }, Ct = "undefined" != typeof module && module.exports, _t = /^\/?Date\((\-?\d+)/i, kt = /(\-)?(?:(\d*)\.)?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?)?/, Nt = /^(-)?P(?:(?:([0-9,.]*)Y)?(?:([0-9,.]*)M)?(?:([0-9,.]*)D)?(?:T(?:([0-9,.]*)H)?(?:([0-9,.]*)M)?(?:([0-9,.]*)S)?)?|([0-9,.]*)W)$/, St = /(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Q|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|S{1,4}|X|zz?|ZZ?|.)/g, Dt = /(\[[^\[]*\])|(\\)?(LT|LL?L?L?|l{1,4})/g, At = /\d\d?/, Mt = /\d{1,3}/, jt = /\d{1,4}/, Lt = /[+\-]?\d{1,6}/, Ot = /\d+/, It = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i, Rt = /Z|[\+\-]\d\d:?\d\d/gi, Ht = /T/i, qt = /[\+\-]?\d+(\.\d{1,3})?/, Pt = /\d{1,2}/, Ft = /\d/, $t = /\d\d/, Bt = /\d{3}/, Wt = /\d{4}/, Yt = /[+-]?\d{6}/, zt = /[+-]?\d+/, Ut = /^\s*(?:[+-]\d{6}|\d{4})-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/, Gt = "YYYY-MM-DDTHH:mm:ssZ", Xt = [
    ...
    function(e) {
        ...
        function t() {
            l(".my-reward-tab-item").click(function() {
                if (!l(this).hasClass("current")) l(".my-reward-tab-item").removeClass("current"), l(this).addClass("current"), v = +l.trim(l(this).attr("data-value")), s = null, i(1)
            })
        }
        ...
        function n() {
            g.on("success", function(e) {
                if (e.bizError) o(e);
                    ...
                    s.render(+e.page), r("returnTicketList", e),
                     l("#my-reward-list .status2").click(function() {
                        l(this).unbind("click"), 
                        l(this).find("ticket-status2-tips").show(), y.remote({
                ...
                if (e.bizError) l(".my-reward-tip").addClass("my-reward-tip-error"), l(".my-reward-tip").html(e.statusInfo), l(".my-reward-tip").slideDown();
                else l(".my-reward-tip").slideDown(), l(".my-reward-tip").addClass("my-reward-tip-success"), l(".my-reward-tip .statusInfo").html(e.msg);
                l(".close-reward-tip").click(function() {
                    l(".my-reward-tip").slideUp()
                });
                var t = l("#my-reward-pager .ui-pager-box .current").attr("data-value");
                i(t ? t : 1)
            })
        }
        ...
        var s, a, l = require("jquery"),
            ...
            g = new m("ACCOUNT_AWARDAPI_TICKETS"),
            y = new m("ACCOUNT_AWARDAPI_EXCHANGE"),
            v = 2,
            b = "YYYY.MM.DD";
        return {
            init: e
