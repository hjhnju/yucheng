! function(e, t) {
    ...
    function N(e, t, n, i, r) {
        for (var o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > o; o += 2) {
            if ("margin" === n) s += lt.css(e, n + En[o], !0, r);
            if (i) {
                if ("content" === n) s -= lt.css(e, "padding" + En[o], !0, r);
                if ("margin" !== n) s -= lt.css(e, "border" + En[o] + "Width", !0, r)
            } else if (s += lt.css(e, "padding" + En[o], !0, r), "padding" !== n) s += lt.css(e, "border" + En[o] + "Width", !0, r)
        }
        return s
    }
        ...
        ready: function(e) {
            if (e === !0 ? !--lt.readyWait : !lt.isReady) {
                ...
                if (lt.isReady = !0, !(e !== !0 && --lt.readyWait > 0))
                    if (U.resolveWith(G, [lt]), lt.fn.trigger) lt(G).trigger("ready").off("ready")
            }
        },
    ...
    if (lt.fn.extend({
                ...
                if (o && 1 === e.nodeType)
                    for (; n = o[r++];) {
                        if (i = lt.propFix[n] || n, Lt.test(n))
                            if (!Mt && Rt.test(n)) e[lt.camelCase("default-" + n)] = e[i] = !1;
                            else e[i] = !1;
                        else lt.attr(e, n, "");
            ...
            get: function(e, n) {
                var i = lt.prop(e, n),
                    ...
                    o = "boolean" == typeof i ? Ht && Mt ? null != r : Rt.test(n) ? e[lt.camelCase("default-" + n)] : !!r : e.getAttributeNode(n);
                return o && o.value !== !1 ? n.toLowerCase() : t
            },
            set: function(e, t, n) {
                if (t === !1) lt.removeAttr(e, n);
                else if (Ht && Mt || !Rt.test(n)) e.setAttribute(!Mt && lt.propFix[n] || n, n);
                else e[lt.camelCase("default-" + n)] = e[n] = !0;
                return n
            }
        }, !Ht || !Mt) lt.attrHooks.value = {
        get: function(e, n) {
            ...
            add: function(e, n, i, r, o) {
                ...
                if (y) {
                    ...
                    for (n = (n || "").match(ft) || [""], l = n.length; l--;) {
                        if (s = Ft.exec(n[l]) || [], h = m = s[1], g = (s[2] || "").split(".").sort(), f = lt.event.special[h] || {}, h = (o ? f.delegateType : f.bindType) || h, f = lt.event.special[h] || {}, p = lt.extend({
                                type: h,
                                origType: m,
                                data: r,
                                handler: i,
            ...
            remove: function(e, t, n, i, r) {
                ...
                if (m && (f = m.events)) {
                    for (t = (t || "").match(ft) || [""], u = t.length; u--;)
                        if (a = Ft.exec(t[u]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d) {
        ...
        function(e, t) {
            ...
            function i() {
                ...
                return e = function(n, i) {
                    if (t.push(n += " ") > E.cacheLength) delete e[t.shift()];
                    return e[n] = i
                }
            }
            ...
            function y(e) {
                for (var t, n, i, r = e.length, o = E.relative[e[0].type], s = o || E.relative[" "], a = o ? 1 : 0, l = d(function(e) {
                    ...
                    if (n = E.relative[e[a].type]) f = [d(h(f), n)];
                    else {
                ...
                var n = 0,
                    ...
                    a = function(r, a, l, u, f) {
                        var c, p, d, h = [],
                            ...
                            x = null != f,
                            b = D,
                            w = r || o && E.find.TAG("*", f && a.parentNode || a),
            ...
            function b(e, t, n, i) {
                ...
                if (!i)
                    if (1 === u.length) {
                        if (o = u[0] = u[0].slice(0), o.length > 2 && "ID" === (s = o[0]).type && 9 === t.nodeType && !R && E.relative[o[1].type]) {
                            if (t = E.find.ID(s.matches[0].replace(bt, wt), t)[0], !t) return n;
                            e = e.slice(o.shift().value.length)
                        }
                        for (r = pt.needsContext.test(e) ? 0 : o.length; r-- && (s = o[r], !E.relative[a = s.type]);)
                            if (l = E.find[a])
            ...
            function w() {}
            var T, C, E, N, k, S, _, D, A, j, L, R, M, H, O, I, q, P = "sizzle" + -new Date,
                F = e.document,
                B = {},
                $ = 0,
                W = 0,
            ...
            k = s.isXML = function(e) {
                ...
                if (j = i, L = i.documentElement, R = k(i), B.tagNameNoComments = o(function(e) {
                ...
                if (E.find.TAG = B.tagNameNoComments ? function(e, t) {
                    ...
                    }, H = [], M = [":focus"], B.qsa = n(i.querySelectorAll)) o(function(e) {
                    if (e.innerHTML = "<select><option selected=''></option></select>", !e.querySelectorAll("[selected]").length) M.push("\\[" + et + "*(?:checked|disabled|ismap|multiple|readonly|selected|value)");
                    if (!e.querySelectorAll(":checked").length) M.push(":checked")
                }), o(function(e) {
                    if (e.innerHTML = "<input type='hidden' i=''/>", e.querySelectorAll("[i^='']").length) M.push("[*^$]=" + et + "*(?:\"\"|'')");
                ...
                if (B.matchesSelector = n(O = L.matchesSelector || L.mozMatchesSelector || L.webkitMatchesSelector || L.oMatchesSelector || L.msMatchesSelector)) o(function(e) {
                    B.disconnectedMatch = O.call(e, "div"), O.call(e, "[s!='']:x"), H.push("!=", ot)
                });
                return M = new RegExp(M.join("|")), H = new RegExp(H.join("|")), I = n(L.contains) || L.compareDocumentPosition ? function(e, t) {
                ...
                if (t = t.replace(xt, "='$1']"), !(!B.matchesSelector || R || H && H.test(t) || M.test(t))) try {
                    var n = O.call(e, t);
                ...
                if (n = E.attrHandle[t]) return n(e);
                if (R || B.attributes) return e.getAttribute(t);
                ...
                filter: {
                    ...
                    PSEUDO: function(e, t) {
                        ...
                        if (i[P]) return i(t);
                        if (i.length > 1) return n = [e, e, "", t], E.setFilters.hasOwnProperty(e.toLowerCase()) ? r(function(e, n) {
            ...
            S = s.compile = function(e, t) {
                ...
                return o
            }, E.pseudos.nth = E.pseudos.eq, E.filters = w.prototype = E.pseudos, E.setFilters = new w, A(), s.attr = lt.attr, lt.find = s, lt.expr = s.selectors, lt.expr[":"] = lt.expr.pseudos, lt.unique = s.uniqueSort, lt.text = s.getText, lt.isXMLDoc = s.isXML, lt.contains = s.contains
        }(e);
    var Bt = /Until$/,
    ...
    if (lt.each(["height", "width"], function(e, t) {
            lt.cssHooks[t] = {
                ...
                set: function(e, n, i) {
                    var r = i && cn(e);
                    return E(e, n, i ? N(e, t, i, lt.support.boxSizing && "border-box" === lt.css(e, "boxSizing", !1, r), r) : 0)
                }
            }
    ...
    lt.each({
        ...
        if (lt.cssHooks[e + t] = {
            ...
            }, !yn.test(e)) lt.cssHooks[e + t].set = E
    });
    var kn = /%20/g,
        Sn = /\[\]$/,
        _n = /\r?\n/g,
    ...
    jn = Bn.exec(Ln.toLowerCase()) || [], lt.fn.load = function(e, n, i) {
        ...
        ajax: function(e, n) {
            function i(e, n, i, r) {
                ...
                if (2 !== b) {
                    ...
                    if (e >= 200 && 300 > e || 304 === e) {
                        ...
                        else o = M(p, x), C = o.state, c = o.data, v = o.error, o = !v
                    } else if (v = C, e || !C)
                        if (C = "error", 0 > e) e = 0;
                    if (T.status = e, T.statusText = (n || C) + "", o) g.resolveWith(d, [c, C, T]);
                    else g.rejectWith(d, [T, C, v]);
                    if (T.statusCode(y), y = t, u) h.trigger(o ? "ajaxSuccess" : "ajaxError", [T, p, o ? c : v]);
                    if (m.fireWith(d, [T, C]), u)
            ...
            if (g.promise(T).complete = m.add, T.success = T.done, T.error = T.fail, p.url = ((e || p.url || Ln) + "").replace(Hn, "").replace(Fn, jn[1] + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = lt.trim(p.dataType || "*").toLowerCase().match(ft) || [""], null == p.crossDomain) r = Bn.exec(p.url.toLowerCase()), p.crossDomain = !(!r || r[1] === jn[1] && r[2] === jn[2] && (r[3] || ("http:" === r[1] ? 80 : 443)) == (jn[3] || ("http:" === jn[1] ? 80 : 443)));
            ...
            if (p.type = p.type.toUpperCase(), p.hasContent = !Pn.test(p.type), s = p.url, !p.hasContent) {
                if (p.data) s = p.url += (Mn.test(s) ? "&" : "?") + p.data, delete p.data;
                if (p.cache === !1) p.url = On.test(s) ? s.replace(On, "$1_=" + Rn++) : s + (Mn.test(s) ? "&" : "?") + "_=" + Rn++
            }
            if (p.ifModified) {
    ...
    lt.ajaxSetup({
        ...
        if (l || "jsonp" === n.dataTypes[0]) {
            ...
            else if (n.jsonp !== !1) n.url += (Mn.test(n.url) ? "&" : "?") + n.jsonp + "=" + o;
    ...
    if (lt.ajaxSettings.xhr = e.ActiveXObject ? function() {
        ...
        } : H, Kn = lt.ajaxSettings.xhr(), lt.support.cors = !!Kn && "withCredentials" in Kn, Kn = lt.support.ajax = !!Kn) lt.ajaxTransport(function(n) {
    ...
    function(e) {
        ...
        function c(e, t, n) {
            var i, r = [],
                ...
                p = "",
                d = "";
            if (n) a = "ts(", l = ")", p = R, d = M, i = o.defaultFilter;
        ...
        r(g, d), r(m, d), r(y, d), r(v, d), r(x, d), r(b, d), r(w, d), r(T, d), r(C, T), r(E, T);
        var I = {
            READING: 1,
            READED: 2,
            APPLIED: 3,
        ...
        y.prototype.applyMaster = g.prototype.applyMaster = function(e) {
            ...
            return l("{0}engine.render({2},{{3}}){1}", R, M, s(this.name), c(this.args, this.engine).replace(/(^|,)\s*([a-z0-9_]+)\s*=/gi, function(e, t, n) {
                return (t || "") + s(n) + ":"
            }))
            ...
            var e = this.args;
            return l("{2}fs[{5}]((function(){{0}{4}{1}})(){6}){3}", L, H, R, M, d.prototype.getRendererBody.call(this), s(this.name), e ? "," + c(e, this.engine) : "")
        };
        var q = {};
        k("target", g), k("block", m), k("import", y), k("use", b), k("var", v), k("for", w), k("if", T), k("elif", C), k("else", E), k("filter", x), S.prototype.config = function(e) {
            t(this.options, e)
    ...
    }), define("help/index", ["require", "jquery", "common/header",'common/extra/Gallery/js/blueimp-gallery'], function(require) {
        function e() {
            t.init(),bindEvents(),slide() 
        }
         ...
         function bindEvents() {
           ...
           $(".menu-list a").click(
            ...
            $(".operate-demo-content .content-title").click(function(){ 
                ...
                var others=$(".operate-demo-content .content-list").not(".current");
                others.slideUp(1000);
            }); 
             //操作演示锚点事件
           $(".menu-list a").click(
    ...
    function slide() { 
        ...
        var $ = require("jquery"), t=require("common/header");
        return {
            init: e
        }
    });
