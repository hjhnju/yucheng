define('common/ui/Form/tabBox', [
    ...
    function _tabBox(e) {
        this.ctrlSelector = e.ctrlSelector || e.control, this.contentSelector = e.contentSelector || e.content, this.eventName = e.eventName || e.event_name, this.current = e.current || e.currentClass, this.defaultSelected = e.defaultSelected || e.default_selected, this.offset = e.offset, this.stopPropagation = e.stopPropagation || e.stop_propagation, this.preventDefault = e.preventDefault || e.prevent_default, this.prevCallback = e.prevCallback || e.prev_callback, this.callback = e.callback, this._init();
    }
