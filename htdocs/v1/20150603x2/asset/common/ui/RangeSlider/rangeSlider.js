define('common/ui/RangeSlider/rangeSlider', [
    'require',
    'jquery'
], function (require) {
    var $ = require('jquery');
    ...
    var base_html = '<span class="irs">' + '<span class="irs-line" tabindex="-1"><span class="irs-line-left"></span><span class="irs-line-mid"></span><span class="irs-line-right"></span></span>' + '<span class="irs-min">0</span><span class="irs-max">1</span>' + '<span class="irs-from">0</span><span class="irs-to">0</span><span class="irs-single">0</span><span class="irs-single-leftnum">0</span>' + '</span>' + '<span class="irs-grid"></span>' + '<span class="irs-bar"></span>';
    ...
    IonRangeSlider.prototype = {
            ...
            if (this.old_from !== this.result.from || this.old_to !== this.result.to || this.force_redraw || this.is_key) {
                ...
                if (this.options.type === 'single') {
                    ...
                    if (this.options.values.length) {
                        ...
                        this.$cache.input.prop('value', this._prettify(this.result.from));
                        this.$cache.input.data('from', this._prettify(this.result.from));
                    }
                } else {
        ...
        drawLabels: function () {
            ...
            var values_num = this.options.values.length, p_values = this.options.p_values, text_single, text_from, text_to, text_single_leftnum;
            if (this.options.hide_from_to) {
                return;
            }
            if (this.options.type === 'single') {
