...
define('common/config', [], function () {
    ...
    var URL = {
            ...
            MY_MSG_DEL: rootUrl + '/msg/del',
            MY_MSG_DELALL: rootUrl + '/msg/delall',
            MY_MSG_SETREADALL: rootUrl + '/msg/readall',
            ...
            ACCOUNT_AWARDAPI_TICKETS: rootUrl + '/account/awardapi/tickets',
            ACCOUNT_AWARDAPI_EXCHANGE: rootUrl + '/account/awardapi/exchange',
            ACCOUNT_INVITEAPI_LIST: rootUrl + '/account/Inviteapi/list',
            APPLY_VERIFY_CHECKEMAIL: rootUrl + '/apply/verify/checkemail',
            APPLY_VERIFY_SUBMIT: rootUrl + '/apply/verify/submit',
            APPLY_BASIC_SUBMIT: rootUrl + '/apply/basic/submit',
            APPLY_SCHOOL_SUBMIT: rootUrl + '/apply/school/submit',
            APPLY_PERSON_SUBMIT: rootUrl + '/apply/person/submit',
            APPLY_REVIEW_SUBMIT: rootUrl + '/apply/review/submit',
            APPLY_VERIFY_CHECKIDCARD: rootUrl + '/apply/verify/checkidcard',
            MY_APPLY_GET: rootUrl + '/apply/api/index',
            MY_ANGEL_LIST: rootUrl + '/angel/api/list',
            MY_ANGEL_ADD: rootUrl + '/angel/api/add',
            MY_ANGELPROFIT_LIST: rootUrl + '/account/angelprofit/list',
            MY_ANGELPROFIT_DETAIL: rootUrl + '/account/angelprofit/repayplan'
        };
    return { URL: URL };
});
