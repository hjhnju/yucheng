! function(e, t) {
		...
		for (var n, i, r, o = [], s = 0, a = e.length; a > s; s++)
			if (i = e[s], i.style) {
				if (o[s] = lt._data(i, "olddisplay"), n = i.style.display, t) {
					...
					if ("" === i.style.display && E(i)) o[s] = lt._data(i, "olddisplay", S(i.nodeName))
				} else if (!o[s])
					if (r = E(i), n && "none" !== n || !r) lt._data(i, "olddisplay", r ? n : lt.css(i, "display"))
			} else;
		for (s = 0; a > s; s++)
			if (i = e[s], i.style) {
	...
	function N(e, t, n, i, r) {
		for (var o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > o; o += 2) {
			if ("margin" === n) s += lt.css(e, n + Tn[o], !0, r);
			if (i) {
				if ("content" === n) s -= lt.css(e, "padding" + Tn[o], !0, r);
				if ("margin" !== n) s -= lt.css(e, "border" + Tn[o] + "Width", !0, r)
			} else if (s += lt.css(e, "padding" + Tn[o], !0, r), "padding" !== n) s += lt.css(e, "border" + Tn[o] + "Width", !0, r)
		}
		return s
	}
	...
	function S(e) {
		var t = K,
			n = wn[e];
		if (!n) {
			if (n = A(e, t), "none" === n || !n) fn = (fn || lt("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement), t = (fn[0].contentWindow || fn[0].contentDocument).document, t.write("<!doctype html><html><body>"), t.close(), n = A(e, t), fn.detach();
			wn[e] = n
		}
		return n
	}
	...
	function B(e, t, n) {
		var i, r, o = 0,
			...
			l = function() {
				if (r) return !1;
				for (var t = Zn || M(), n = Math.max(0, u.startTime + u.duration - t), i = n / u.duration || 0, o = 1 - i, s = 0, l = u.tweens.length; l > s; s++) u.tweens[s].run(o);
			...
			f = u.props;
		for (P(f, u.opts.specialEasing); s > o; o++)
	...
	var G, X, U = typeof t,
		...
		wt = function(e) {
			if (K.addEventListener || "load" === e.type || "complete" === K.readyState) Et(), lt.ready()
		},
		Et = function() {
	...
	lt.fn = lt.prototype = {
		...
		ready: function(e) {
			if (e === !0 ? !--lt.readyWait : !lt.isReady) {
				...
				if (lt.isReady = !0, !(e !== !0 && --lt.readyWait > 0))
					if (G.resolveWith(K, [lt]), lt.fn.trigger) lt(K).trigger("ready").off("ready")
			}
		},
		...
		if (!G)
			if (G = lt.Deferred(), "complete" === K.readyState) setTimeout(lt.ready);
	...
	if (lt.fn.extend({
			...
			attr: function(e, n, i) {
				...
				if (e && 3 !== a && 8 !== a && 2 !== a) {
					if (typeof e.getAttribute === U) return lt.prop(e, n, i);
					...
					if (i !== t)
						...
						if (typeof e.getAttribute !== U) s = e.getAttribute(n);
						return null == s ? t : s
					}
				}
			},
				...
				if (o && 1 === e.nodeType)
					for (; n = o[r++];) {
						if (i = lt.propFix[n] || n, Lt.test(n))
							if (!Ht && Rt.test(n)) e[lt.camelCase("default-" + n)] = e[i] = !1;
							else e[i] = !1;
						else lt.attr(e, n, "");
			...
			get: function(e, n) {
				var i = lt.prop(e, n),
					...
					o = "boolean" == typeof i ? It && Ht ? null != r : Rt.test(n) ? e[lt.camelCase("default-" + n)] : !!r : e.getAttributeNode(n);
				return o && o.value !== !1 ? n.toLowerCase() : t
			},
			set: function(e, t, n) {
				if (t === !1) lt.removeAttr(e, n);
				else if (It && Ht || !Rt.test(n)) e.setAttribute(!Ht && lt.propFix[n] || n, n);
				else e[lt.camelCase("default-" + n)] = e[n] = !0;
				return n
			}
		}, !It || !Ht) lt.attrHooks.value = {
		get: function(e, n) {
	...
	if (lt.event = {
			...
			add: function(e, n, i, r, o) {
				...
				if (y) {
					...
					if (!(c = y.handle)) c = y.handle = function(e) {
						return typeof lt !== U && (!e || lt.event.triggered !== e.type) ? lt.event.dispatch.apply(c.elem, arguments) : t
					}, c.elem = e;
					for (n = (n || "").match(ft) || [""], l = n.length; l--;) {
						if (s = Pt.exec(n[l]) || [], h = m = s[1], g = (s[2] || "").split(".").sort(), f = lt.event.special[h] || {}, h = (o ? f.delegateType : f.bindType) || h, f = lt.event.special[h] || {}, p = lt.extend({
								type: h,
								origType: m,
								data: r,
								handler: i,
			...
			remove: function(e, t, n, i, r) {
				...
				if (m && (f = m.events)) {
					for (t = (t || "").match(ft) || [""], u = t.length; u--;)
						if (a = Pt.exec(t[u]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d) {
			...
			trigger: function(n, i, r, o) {
				...
				if (l = c = r = r || K, 3 !== r.nodeType && 8 !== r.nodeType)
					if (!Bt.test(h + lt.event.triggered)) {
						...
						if (i = null == i ? [n] : lt.makeArray(i, [n]), f = lt.event.special[h] || {}, o || !f.trigger || f.trigger.apply(r, i) !== !1) {
							if (!o && !f.noBubble && !lt.isWindow(r)) {
								if (u = f.delegateType || h, !Bt.test(u + h)) l = l.parentNode;
			...
			fix: function(e) {
				...
				var t, n, i, r = e.type,
					o = e,
					s = this.fixHooks[r];
				if (!s) this.fixHooks[r] = s = qt.test(r) ? this.mouseHooks : Mt.test(r) ? this.keyHooks : {};
	...
	lt.fn.extend({
		...
		function(e, t) {
			...
			function s(e, t, n, i) {
				...
				if ((t ? t.ownerDocument || t : P) !== j) _(t);
				...
				if (!R && !i) {
					...
					if (F.qsa && !H.test(e)) {
						if (f = !0, d = B, h = t, g = 9 === a && e, 1 === a && "object" !== t.nodeName.toLowerCase()) {
			...
			function d(e, t, n) {
				...
				return t.first ? function(t, n, o) {
					...
					if (s) {
						...
						for (; t = t[i];)
							if (1 === t.nodeType || r)
								if (u = t[B] || (t[B] = {}), (l = u[i]) && l[0] === f) {
									if ((a = l[1]) === !0 || a === C) return a === !0
								} else if (l = u[i] = [f], l[1] = e(t, n, s) || C, l[1] === !0) return !0
				}
			}
			...
			function y(e) {
				for (var t, n, i, r = e.length, o = T.relative[e[0].type], s = o || T.relative[" "], a = o ? 1 : 0, l = d(function(e) {
					...
					if (n = T.relative[e[a].type]) f = [d(h(f), n)];
					else {
				...
				var n = 0,
					...
					a = function(r, a, l, u, f) {
						var c, p, d, h = [],
							...
							b = null != f,
							x = D,
							w = r || o && T.find.TAG("*", f && a.parentNode || a),
							E = $ += null == x ? 1 : Math.random() || .1;
						if (b) D = a !== j && a, C = n;
						for (; null != (c = w[y]); y++) {
							if (o && c) {
								for (p = 0; d = e[p++];)
						...
						if (m += y, i && y !== m) {
							...
							if (J.apply(u, h), b && !r && h.length > 0 && m + t.length > 1) s.uniqueSort(u)
						}
						if (b) $ = E, D = x;
						return v
					};
			...
			function x(e, t, n, i) {
				...
				if (!i)
					if (1 === u.length) {
						if (o = u[0] = u[0].slice(0), o.length > 2 && "ID" === (s = o[0]).type && 9 === t.nodeType && !R && T.relative[o[1].type]) {
			...
			function w() {}
			var E, C, T, N, k, S, A, D, _, j, L, R, H, I, O, M, q, B = "sizzle" + -new Date,
				P = e.document,
				F = {},
				$ = 0,
				W = 0,
			...
			k = s.isXML = function(e) {
				...
				if (j = i, L = i.documentElement, R = k(i), F.tagNameNoComments = o(function(e) {
						...
						e.id = B + 0, e.innerHTML = "<a name='" + B + "'></a><div name='" + B + "'></div>", L.insertBefore(e, L.firstChild);
						var t = i.getElementsByName && i.getElementsByName(B).length === 2 + i.getElementsByName(B + 0).length;
						return F.getIdNotName = !i.getElementById(B), L.removeChild(e), t
					...
					if (typeof t.getElementById !== U && !R) {
				...
				else T.find.ID = function(e, n) {
					if (typeof n.getElementById !== U && !R) {
						var i = n.getElementById(e);
						return i ? i.id === e || typeof i.getAttributeNode !== U && i.getAttributeNode("id").value === e ? [i] : t : []
					}
				}, T.filter.ID = function(e) {
					var t = e.replace(xt, wt);
					return function(e) {
				...
				if (T.find.TAG = F.tagNameNoComments ? function(e, t) {
						...
						if (typeof t.getElementsByName !== U) return t.getElementsByName(name);
						else return void 0
					}, T.find.CLASS = F.getByClassName && function(e, t) {
						if (typeof t.getElementsByClassName !== U && !R) return t.getElementsByClassName(e);
						else return void 0
					}, I = [], H = [":focus"], F.qsa = n(i.querySelectorAll)) o(function(e) {
					if (e.innerHTML = "<select><option selected=''></option></select>", !e.querySelectorAll("[selected]").length) H.push("\\[" + et + "*(?:checked|disabled|ismap|multiple|readonly|selected|value)");
					if (!e.querySelectorAll(":checked").length) H.push(":checked")
				}), o(function(e) {
					if (e.innerHTML = "<input type='hidden' i=''/>", e.querySelectorAll("[i^='']").length) H.push("[*^$]=" + et + "*(?:\"\"|'')");
				...
				if (F.matchesSelector = n(O = L.matchesSelector || L.mozMatchesSelector || L.webkitMatchesSelector || L.oMatchesSelector || L.msMatchesSelector)) o(function(e) {
					F.disconnectedMatch = O.call(e, "div"), O.call(e, "[s!='']:x"), I.push("!=", ot)
				});
				return H = new RegExp(H.join("|")), I = new RegExp(I.join("|")), M = n(L.contains) || L.compareDocumentPosition ? function(e, t) {
					...
					if (n = t.compareDocumentPosition && e.compareDocumentPosition && e.compareDocumentPosition(t)) {
						if (1 & n || e.parentNode && 11 === e.parentNode.nodeType) {
							if (e === i || M(P, e)) return -1;
							if (t === i || M(P, t)) return 1;
							else return 0
						}
						return 4 & n ? -1 : 1
					}
				...
				}, A = !1, [0, 0].sort(q), F.detectDuplicates = A, j
			}, s.matches = function(e, t) {
				return s(e, null, null, t)
			}, s.matchesSelector = function(e, t) {
				if ((e.ownerDocument || e) !== j) _(e);
				if (t = t.replace(bt, "='$1']"), !(!F.matchesSelector || R || I && I.test(t) || H.test(t))) try {
					var n = O.call(e, t);
				...
				if (n = T.attrHandle[t]) return n(e);
				...
				var t, n = [],
					i = 1,
					r = 0;
				if (A = !F.detectDuplicates, e.sort(q), A) {
					for (; t = e[i]; i++)
				...
				filter: {
						...
						return 1 === i && 0 === r ? function(e) {
							...
							if (m) {
								...
								if (h = [s ? m.firstChild : m.lastChild], s && v) {
									for (f = m[B] || (m[B] = {}), u = f[e] || [], d = u[0] === $ && u[1], p = u[0] === $ && u[2], c = d && m.childNodes[d]; c = ++d && c && c[g] || (p = d = 0) || h.pop();)
										if (1 === c.nodeType && ++p && c === t) {
											f[e] = [$, d, p];
											break
										}
								} else if (v && (u = (t[B] || (t[B] = {}))[e]) && u[0] === $) p = u[1];
								else
					...
					PSEUDO: function(e, t) {
						...
						if (i[B]) return i(t);
						if (i.length > 1) return n = [e, e, "", t], T.setFilters.hasOwnProperty(e.toLowerCase()) ? r(function(e, n) {
			...
			S = s.compile = function(e, t) {
				...
				if (!o) {
					if (!t) t = c(e);
					for (n = t.length; n--;)
						if (o = y(t[n]), o[B]) i.push(o);
						else r.push(o);
					o = X(e, v(r, i))
				}
				return o
			}, T.pseudos.nth = T.pseudos.eq, T.filters = w.prototype = T.pseudos, T.setFilters = new w, _(), s.attr = lt.attr, lt.find = s, lt.expr = s.selectors, lt.expr[":"] = lt.expr.pseudos, lt.unique = s.uniqueSort, lt.text = s.getText, lt.isXMLDoc = s.isXML, lt.contains = s.contains
		}(e);
	var Ft = /Until$/,
	...
	lt.fn.extend({
		...
		lt.fn[e] = function(n, i) {
			...
			if (r = this.length > 1 && !Gt[e] ? lt.unique(r) : r, this.length > 1 && $t.test(e)) r = r.reverse();
	...
	an.optgroup = an.option, an.tbody = an.tfoot = an.colgroup = an.caption = an.thead, an.th = an.td, lt.fn.extend({
		...
		remove: function(e, t) {
			for (var n, i = 0; null != (n = this[i]); i++)
				if (!e || lt.filter(e, [n]).length > 0) {
					...
					if (n.parentNode) {
						if (t && lt.contains(n.ownerDocument, n)) m(b(n, "script"));
		...
		clone: function(e, t, n) {
			...
			if (i = b(o, "script"), i.length > 0) m(i, !l && b(e, "script"));
			return i = a = r = null, o
		},
		buildFragment: function(e, t, n, i) {
			...
			for (g = 0; o = h[g++];)
				if (!i || -1 === lt.inArray(o, i)) {
					if (s = lt.contains(o.ownerDocument, o), a = b(d.appendChild(o), "script"), s) m(a);
					if (n)
						for (r = 0; o = a[r++];)
				...
				if (t || lt.acceptData(n))
					if (r = n[a], o = r && l[r]) {
						...
						if (l[r]) {
							...
							else if (typeof n.removeAttribute !== U) n.removeAttribute(a);
							else n[a] = null;
							Z.push(r)
						}
					}
	...
	if (lt.each(["height", "width"], function(e, t) {
			lt.cssHooks[t] = {
				get: function(e, n, i) {
					if (n) return 0 === e.offsetWidth && mn.test(lt.css(e, "display")) ? lt.swap(e, En, function() {
						return k(e, t, i)
					}) : k(e, t, i);
					else return void 0
				},
				set: function(e, n, i) {
					var r = i && cn(e);
					return T(e, n, i ? N(e, t, i, lt.support.boxSizing && "border-box" === lt.css(e, "boxSizing", !1, r), r) : 0)
				}
			}
	...
	lt.each({
		...
		if (lt.cssHooks[e + t] = {
			...
			}, !yn.test(e)) lt.cssHooks[e + t].set = T
	});
	var kn = /%20/g,
		Sn = /\[\]$/,
		An = /\r?\n/g,
	...
	lt.fn.extend({
		...
		serializeArray: function() {
			return this.map(function() {
				...
				var e = this.type;
				return this.name && !lt(this).is(":disabled") && _n.test(this.nodeName) && !Dn.test(e) && (this.checked || !tn.test(e))
			}).map(function(e, t) {
				var n = lt(this).val();
		...
		ajax: function(e, n) {
			function i(e, n, i, r) {
				...
				if (2 !== x) {
					...
					if (f = t, a = r || "", E.readyState = e > 0 ? 4 : 0, i) b = R(p, E, i);
					if (e >= 200 && 300 > e || 304 === e) {
						if (p.ifModified) {
							if (w = E.getResponseHeader("Last-Modified")) lt.lastModified[s] = w;
							if (w = E.getResponseHeader("etag")) lt.etag[s] = w
						}
						if (204 === e) o = !0, C = "nocontent";
						else if (304 === e) o = !0, C = "notmodified";
						else o = H(p, b), C = o.state, c = o.data, v = o.error, o = !v
					} else if (v = C, e || !C)
						if (C = "error", 0 > e) e = 0;
					if (E.status = e, E.statusText = (n || C) + "", o) g.resolveWith(d, [c, C, E]);
					else g.rejectWith(d, [E, C, v]);
					if (E.statusCode(y), y = t, u) h.trigger(o ? "ajaxSuccess" : "ajaxError", [E, p, o ? c : v]);
					if (m.fireWith(d, [E, C]), u)
						if (h.trigger("ajaxComplete", [E, p]), !--lt.active) lt.event.trigger("ajaxStop")
				}
			}
			...
			if (g.promise(E).complete = m.add, E.success = E.done, E.error = E.fail, p.url = ((e || p.url || Ln) + "").replace(In, "").replace(Pn, jn[1] + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = lt.trim(p.dataType || "*").toLowerCase().match(ft) || [""], null == p.crossDomain) r = Fn.exec(p.url.toLowerCase()), p.crossDomain = !(!r || r[1] === jn[1] && r[2] === jn[2] && (r[3] || ("http:" === r[1] ? 80 : 443)) == (jn[3] || ("http:" === jn[1] ? 80 : 443)));
			if (p.data && p.processData && "string" != typeof p.data) p.data = lt.param(p.data, p.traditional);
			if (j(Wn, p, n, E), 2 === x) return E;
			if (u = p.global, u && 0 === lt.active++) lt.event.trigger("ajaxStart");
			if (p.type = p.type.toUpperCase(), p.hasContent = !Bn.test(p.type), s = p.url, !p.hasContent) {
				if (p.data) s = p.url += (Hn.test(s) ? "&" : "?") + p.data, delete p.data;
				if (p.cache === !1) p.url = On.test(s) ? s.replace(On, "$1_=" + Rn++) : s + (Hn.test(s) ? "&" : "?") + "_=" + Rn++
			}
			if (p.ifModified) {
				if (lt.lastModified[s]) E.setRequestHeader("If-Modified-Since", lt.lastModified[s]);
				if (lt.etag[s]) E.setRequestHeader("If-None-Match", lt.etag[s])
			}
			if (p.data && p.hasContent && p.contentType !== !1 || n.contentType) E.setRequestHeader("Content-Type", p.contentType);
			E.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Gn + "; q=0.01" : "") : p.accepts["*"]);
			...
			if (f = j(zn, p, n, E), !f) i(-1, "No Transport");
			else {
				if (E.readyState = 1, u) h.trigger("ajaxSend", [E, p]);
	...
	lt.ajaxSetup({
		...
		if (l || "jsonp" === n.dataTypes[0]) {
			...
			else if (n.jsonp !== !1) n.url += (Hn.test(n.url) ? "&" : "?") + n.jsonp + "=" + o;
			return n.converters["script json"] = function() {
				...
				if (e[o] = s, n[o]) n.jsonpCallback = i.jsonpCallback, Un.push(o);
	...
	if (lt.ajaxSettings.xhr = e.ActiveXObject ? function() {
		...
		} : I, Vn = lt.ajaxSettings.xhr(), lt.support.cors = !!Vn && "withCredentials" in Vn, Vn = lt.support.ajax = !!Vn) lt.ajaxTransport(function(n) {
	...
	if (lt.fn.offset = function(e) {
			...
			if (s) {
				...
				if (typeof o.getBoundingClientRect !== U) r = o.getBoundingClientRect();
				return i = z(s), {
	...
	function(e) {
		...
		function c(e, t, n) {
			var i, r = [],
				...
				p = "",
				d = "";
			if (n) a = "ts(", l = ")", p = R, d = H, i = o.defaultFilter;
		...
		var D = 178245,
			...
			H = ";",
			I = "return r;";
		if ("undefined" != typeof navigator && /msie\s*([0-9]+)/i.test(navigator.userAgent) && RegExp.$1 - 0 < 8) L = "var r=[],ri=0;", R = "r[ri++]=", I = 'return r.join("");';
		p.prototype = {
		...
		r(g, d), r(m, d), r(y, d), r(v, d), r(b, d), r(x, d), r(w, d), r(E, d), r(C, E), r(T, E);
		var M = {
			READING: 1,
			READED: 2,
			APPLIED: 3,
		...
		y.prototype.applyMaster = g.prototype.applyMaster = function(e) {
			...
			if (this.state >= M.APPLIED) return 1;
			var n = this.blocks,
				i = this.engine.targets[e];
			if (i && i.applyMaster(i.master)) return this.children = i.clone().children, t(this), this.state = M.APPLIED, 1;
			else return void 0
			...
			if (this.state >= M.READY) return 1;
			var t = this.engine,
				n = 1;
			if (this.applyMaster(this.master)) return e(this), n && (this.state = M.READY), n;
			else return void 0
			...
			h(e), d.prototype.open.call(this, e), this.state = M.READING, N(this, e)
			...
			this.parent = e.stack.top(), this.target = e.target, d.prototype.open.call(this, e), this.state = M.READING, e.imp = this
		}, x.prototype.close = v.prototype.close = function() {}, y.prototype.close = function(e) {
			d.prototype.close.call(this, e), this.state = M.READED, e.imp = null
		}, g.prototype.close = function(e) {
			d.prototype.close.call(this, e), this.state = this.master ? M.READED : M.APPLIED, e.target = null
		...
		}, x.prototype.beforeOpen = y.prototype.beforeOpen = v.prototype.beforeOpen = w.prototype.beforeOpen = b.prototype.beforeOpen = m.prototype.beforeOpen = E.prototype.beforeOpen = p.prototype.beforeAdd = function(e) {
			if (!e.stack.bottom()) {
			...
			return l("{0}engine.render({2},{{3}}){1}", R, H, s(this.name), c(this.args, this.engine).replace(/(^|,)\s*([a-z0-9_]+)\s*=/gi, function(e, t, n) {
				return (t || "") + s(n) + ":"
			}))
			...
			var e = this.args;
			return l("{2}fs[{5}]((function(){{0}{4}{1}})(){6}){3}", L, I, R, H, d.prototype.getRendererBody.call(this), s(this.name), e ? "," + c(e, this.engine) : "")
		};
		var q = {};
		k("target", g), k("block", m), k("import", y), k("use", x), k("var", v), k("for", w), k("if", E), k("elif", C), k("else", T), k("filter", b), S.prototype.config = function(e) {
			t(this.options, e)
		...
		var B = new S;
		if (B.Engine = S, "object" == typeof exports && "object" == typeof module) exports = module.exports = B;
		else if ("function" == typeof define && define.amd) define("etpl/main", [], B);
		else e.etpl = B
	...
	}), define("common/header", ["require", "jquery", "etpl", "./common.tpl"], function(require) {
		function e() {
			o.compile(s), n(), t(), i()
		}
		...
		function e(e) {
			i = e || "login", s.init(), o.init(), t(), n()
		}

		function t() {
			r(".login .login-input").on({
				focus: function() {
					var e = r(this).parent(),
		...
		function e(e) {
			i = e ? 1 : 0, u.compile(f), o.init(), a.init(), t(), n(),yazma()
		}

		function t() {
			r(".regist .login-input").on({
				focus: function() {
					var e = r(this).parent(),
						t = e.children(".username-error");
						var id = r(this).attr('id');
						var pointIcon = e.find("#"+id+"-point");
                        var pointTip=e.find(".username-point");
					e.removeClass("current"), t.html("") ,  pointIcon.html(""),
                pointTip.show(),r(this).next().addClass("hidden")
				},
				blur: function() {
					var e = r(this).parent(),
						t = r.trim(r(this).val()),
						n = r(this).attr("data-text"),
						i = r(this).attr("id"); 
						e.find("#"+i+"-point").removeClass("hidden");
					if (!t) {
						if (!r(this).hasClass("login-tuijian")) e.addClass("current"), r("#" + i + "-error").html(n + "不能为空");
						 r(this).next().removeClass("hidden")
					}
				}
			}), x.loginUser.blur(function() {
				var e = r.trim(r(this).val());
				if (e) p.remote({
					name: e
				});
				else E.user = 0
			}), x.loginPwd.blur(function() {
				var e = r.trim(r(this).val());
				if (!e) return void(E.pwd = 0);
				if (!v.test(e)) return E.pwd = 0, r(this).parent().addClass("current"), void w.pwdError.html("密码只能为 6 - 32 位数字，字母及常用符号组成");
				else return E.pwd = 1,void point.pwdPointTip.hide(), void point.pwdPointIcon.html(b)
			}) ,x.loginPwd2.blur(function() {
				var e = r.trim(r(this).val()); 
				var pwd = r.trim(r(x.loginPwd).val());
				if (!e) return void(E.pwd = 0);
				if (pwd!=e) return E.pwd = 0, r(this).parent().addClass("current"), void w.pwd2Error.html("两次输入的密码不一致 ");
				else return E.pwd = 1,void point.pwd2PointTip.hide(), void point.pwd2PointIcon.html(b)
			}), x.loginPhone.blur(function() {
				var e = r.trim(r(this).val());
				if (e) d.remote({
					phone: e
				});
				else E.phone = 0, r(".login-username-testing").addClass("disabled")
			}), x.loginTest.blur(function() {
				var e = r.trim(r(this).val()),
					t = r.trim(x.loginPhone.val());
				if (!t) return x.loginPhone.trigger("blur"), void(E.vericode = 0);
				if (e) m.remote({
					vericode: e,
					phone: t,
					type: "regist"
			...
			}), r(".login-username-testing").click(s.debounce(function(e) {
				e.preventDefault();
				var t = r.trim(x.loginPhone.val());
				if (!r(this).hasClass("disabled") && t) h.remote({
					phone: t,
					type: "regist"
				})
			}, 1e3)), x.loginTuiJian.blur(function() {
				var e = r.trim(r(this).val());
				if (e) g.remote({
					inviter: e
				})
			}), r(".regist .login-fastlogin").click(s.debounce(function(e) {
				e.preventDefault();
				var t = 1;
				if (!r("#tiaoyue-itp")[0].checked) return void alert("请同意用户条约");
				for (var n in E)
					if (E.hasOwnProperty(n))
						if (!E[n]) x[C[n]].trigger("blur"), t = 0;
				t && y.remote({
					name: x.loginUser.val(),
					passwd: x.loginPwd.val(),
					phone: x.loginPhone.val(),
					inviter: x.loginTuiJian.val(),
					vericode: x.loginTest.val(),
					isthird: i
				})
			}, 1e3))
		}
		...
		function n() {
			...
			p.on("success", function(e) {
				if (e && e.bizError) x.loginUser.parent().addClass("current"), w.userError.html(e.statusInfo), E.user = 0;
				else  point.userPointTip.hide(), point.userPointIcon.html(b), E.user = 1
			}), d.on("success", function(e) {
				if (e && e.bizError) x.loginPhone.parent().addClass("current"), w.phoneError.html(e.statusInfo), E.phone = 0, r(".login-username-testing").addClass("disabled");
				else point.phonePointTip.hide(), point.phonePointIcon.html(b), E.phone = 1, r(".login-username-testing").removeClass("disabled")
			}), g.on("success", function(e) {
				if (e && e.bizError) x.loginTuiJian.parent().addClass("current"), w.tuiJianError.html(e.statusInfo), E.tui = 0;
				else point.tuiJianPointTip.hide(), point.tuiJianPointIcon.html(b), E.tui = 1
			}), h.on("success", function(t) {
				var n = 60;
				if (t && t.bizError) alert(t.statusInfo);
				else {
					var i = r("#testing-wait");var testing=r(".login-username-testing"); var testTip=r(".testTip");
					i.text("60秒后重新发送"), i.addClass("show"),testing.addClass("login-username-testing-wait"), testing.addClass("disabled"), testTip.hide()
, e = setInterval(function() {
						if (i.text(--n + "秒后重新发送"), 0 > n) clearInterval(e), i.removeClass("show"),testing.removeClass("login-username-testing-wait"),testing.removeClass("disabled")
					}, 1e3)
				}
			}), m.on("success", function(e) {
				if (e && e.bizError) x.loginTest.parent().addClass("current"), w.testError.html(e.statusInfo), E.vericode = 0;
				else point.testPointTip.hide(), point.testPointIcon.html(b), E.vericode = 1
			}), y.on("success", function(e) {
				if (e && e.bizError) alert(e.statusInfo);
				else window.location.href = "/user/open/index"
			}), r(".fix-box-register").click(function() {
				a.show({
					width: 500,
					defaultTitle: !1,
					content: u.render("fixBox")
				}), l.init("registBind")
			})
		}
	    ...
	    function yazma () {
	          var e = r(".login-username-testing");
		...
		var i, r = require("jquery"),
			o = require("../common/picScroll"),
			s = require("common/util"),
			a = (require("common/header"), require("common/ui/Dialog/Dialog")),
			l = require("setting/login/index"),
			u = require("etpl"),
			f = require("./regist.tpl"),
			c = require("common/Remoter"),
			p = new c("REGIST_CHECKNAME_CHECK"),
			d = new c("REGIST_CHECKPHONE_CHECK"),
			h = new c("REGIST_SENDSMSCODE_CHECK"),
			g = new c("REGIST_CHECKINVITER_CHECK"),
			m = new c("REGIST_CHECKSMSCODE_CHECK"),
			y = new c("REGIST_INDEX_CHECK"),
			v = /^[a-zA-Z0-9!@#$%^&'\(\({}=+\-]{6,20}$/,
			b = '<span class="username-error-span"></span>',
			x = {
				loginUser: r("#regist-user"),
				loginPwd: r("#regist-pwd"),
				loginPwd2: r("#regist-pwd2"),
				loginPhone: r("#regist-phone"),
				loginTest: r("#regist-testing"),
				loginTuiJian: r("#regist-tuijian")
			},
			w = {
				userError: r("#regist-user-error"),
				phoneError: r("#regist-phone-error"),
				pwd2Error: r("#regist-pwd2-error"),
				pwdError: r("#regist-pwd-error"),
				testError: r("#regist-testing-error"),
				tuiJianError: r("#regist-tuijian-error")

			},
			point = {
		        userPointIcon: r('#regist-user-point'),
		        phonePointIcon: r('#regist-phone-point'),
		        pwdPointIcon: r('#regist-pwd-point'),
		        pwd2PointIcon: r('#regist-pwd2-point'),
		        testPointIcon: r('#regist-testing-point'),
		        tuiJianPointIcon: r('#regist-tuijian-point'),

		        userPointTip: r('#regist-user-point').next(),
		        phonePointTip: r('#regist-phone-point').next(),
		        pwdPointTip: r('#regist-pwd-point').next(),
		        pwd2PointTip: r('#regist-pwd2-point').next(),
		        testPointTip: r('#regist-testing-point').next(),
		        tuiJianPointTip: r('#regist-tuijian-point').next()
		    },
			E = {
				user: 0,
				phone: 0,
