(function (factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define('common/extra/Gallery/js/blueimp-gallery-youtube', [
            './blueimp-helper',
    ...
    var textFactory = Gallery.prototype.textFactory || Gallery.prototype.imageFactory, YouTubePlayer = function (videoId, playerVars, clickToPlay) {
    ...
    $.extend(YouTubePlayer.prototype, {
        ...
        loadAPI: function () {
            var that = this, onYouTubeIframeAPIReady = window.onYouTubeIframeAPIReady, apiUrl = '//www.youtube.com/iframe_api', scriptTags = document.getElementsByTagName('script'), i = scriptTags.length, scriptTag;
    ...
    $.extend(Gallery.prototype, {
        ...
        textFactory: function (obj, callback) {
            var options = this.options, videoId = this.getItemProperty(obj, options.youTubeVideoIdProperty);
            if (videoId) {
