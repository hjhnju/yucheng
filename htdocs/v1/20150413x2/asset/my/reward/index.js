! function(e, t) {
        ...
        for (var n, i, r, o = [], s = 0, a = e.length; a > s; s++)
            if (i = e[s], i.style) {
                if (o[s] = lt._data(i, "olddisplay"), n = i.style.display, t) {
                    ...
                    if ("" === i.style.display && T(i)) o[s] = lt._data(i, "olddisplay", N(i.nodeName))
                } else if (!o[s])
    ...
    function k(e, t, n) {
        ...
        return r + _(e, t, n || (s ? "border" : "content"), i, o) + "px"
    }
    ...
    function $(e, t, n) {
        ...
        if (1 === e.nodeType && ("height" in t || "width" in t))
            if (n.overflow = [d.overflow, d.overflowX, d.overflowY], "inline" === lt.css(e, "display") && "none" === lt.css(e, "float"))
                if (!lt.support.inlineBlockNeedsLayout || "inline" === N(e.nodeName)) d.display = "inline-block";
                else d.zoom = 1;
        if (n.overflow)
    ...
    lt.fn = lt.prototype = {
        ...
        ready: function(e) {
            if (e === !0 ? !--lt.readyWait : !lt.isReady) {
                ...
                if (lt.isReady = !0, !(e !== !0 && --lt.readyWait > 0))
                    if (z.resolveWith(X, [lt]), lt.fn.trigger) lt(X).trigger("ready").off("ready")
            }
        },
        ...
        if (!z)
            if (z = lt.Deferred(), "complete" === X.readyState) setTimeout(lt.ready);
    ...
    if (lt.fn.extend({
            ...
            attr: function(e, n, i) {
                ...
                if (e && 3 !== a && 8 !== a && 2 !== a) {
                    ...
                    if (o = 1 !== a || !lt.isXMLDoc(e)) n = n.toLowerCase(), r = lt.attrHooks[n] || (jt.test(n) ? Nt : kt);
                    if (i !== t)
            ...
            removeAttr: function(e, t) {
                ...
                if (o && 1 === e.nodeType)
                    for (; n = o[r++];) {
                        if (i = lt.propFix[n] || n, jt.test(n))
                            if (!Ot && Lt.test(n)) e[lt.camelCase("default-" + n)] = e[i] = !1;
                            else e[i] = !1;
                        else lt.attr(e, n, "");
            ...
            get: function(e, n) {
                var i = lt.prop(e, n),
                    ...
                    o = "boolean" == typeof i ? Rt && Ot ? null != r : Lt.test(n) ? e[lt.camelCase("default-" + n)] : !!r : e.getAttributeNode(n);
                return o && o.value !== !1 ? n.toLowerCase() : t
            },
            set: function(e, t, n) {
                if (t === !1) lt.removeAttr(e, n);
                else if (Rt && Ot || !Lt.test(n)) e.setAttribute(!Ot && lt.propFix[n] || n, n);
                else e[lt.camelCase("default-" + n)] = e[n] = !0;
                return n
            }
        }, !Rt || !Ot) lt.attrHooks.value = {
        get: function(e, n) {
    ...
    if (!lt.support.changeBubbles) lt.event.special.change = {
        setup: function() {
            ...
            lt.event.add(this, "beforeactivate._change", function(e) {
                var t = e.target;
                if (Ht.test(t.nodeName) && !lt._data(t, "changeBubbles")) lt.event.add(t, "change._change", function(e) {
    ...
    lt.fn.extend({
        ...
        function(e, t) {
            ...
            function s(e, t, n, i) {
                ...
                if ((t ? t.ownerDocument || t : F) !== M) A(t);
                if (t = t || M, n = n || [], !e || "string" != typeof e) return n;
            ...
            function c(e, t) {
                ...
                return t ? a.length : a ? s.error(e) : z(e, l).slice(0)
            }
            ...
            function x(e, t, n, i) {
                ...
                if (!i)
                    if (1 === u.length) {
                        if (o = u[0] = u[0].slice(0), o.length > 2 && "ID" === (s = o[0]).type && 9 === t.nodeType && !L && C.relative[o[1].type]) {
                ...
                return N(e, u)(i, t, L, n, dt.test(e)), n
            }

            function w() {}
            var T, E, C, _, k, N, S, D, A, M, j, L, O, R, H, I, q, P = "sizzle" + -new Date,
                F = e.document,
                $ = {},
                B = 0,
                W = 0,
            ...
            k = s.isXML = function(e) {
                ...
                if (M = i, j = i.documentElement, L = k(i), $.tagNameNoComments = o(function(e) {
                        ...
                        return $.getIdNotName = !i.getElementById(P), j.removeChild(e), t
                ...
                if (C.find.TAG = $.tagNameNoComments ? function(e, t) {
                    ...
                    }, R = [], O = [":focus"], $.qsa = n(i.querySelectorAll)) o(function(e) {
                    if (e.innerHTML = "<select><option selected=''></option></select>", !e.querySelectorAll("[selected]").length) O.push("\\[" + et + "*(?:checked|disabled|ismap|multiple|readonly|selected|value)");
                    if (!e.querySelectorAll(":checked").length) O.push(":checked")
                }), o(function(e) {
                    if (e.innerHTML = "<input type='hidden' i=''/>", e.querySelectorAll("[i^='']").length) O.push("[*^$]=" + et + "*(?:\"\"|'')");
                    if (!e.querySelectorAll(":enabled").length) O.push(":enabled", ":disabled");
                    e.querySelectorAll("*,:x"), O.push(",.*:")
                });
                if ($.matchesSelector = n(H = j.matchesSelector || j.mozMatchesSelector || j.webkitMatchesSelector || j.oMatchesSelector || j.msMatchesSelector)) o(function(e) {
                    $.disconnectedMatch = H.call(e, "div"), H.call(e, "[s!='']:x"), R.push("!=", ot)
                });
                return O = new RegExp(O.join("|")), R = new RegExp(R.join("|")), I = n(j.contains) || j.compareDocumentPosition ? function(e, t) {
                ...
                }, S = !1, [0, 0].sort(q), $.detectDuplicates = S, M
            }, s.matches = function(e, t) {
                return s(e, null, null, t)
            }, s.matchesSelector = function(e, t) {
                if ((e.ownerDocument || e) !== M) A(e);
                if (t = t.replace(bt, "='$1']"), !(!$.matchesSelector || L || R && R.test(t) || O.test(t))) try {
                    var n = H.call(e, t);
                ...
                var n;
                if ((e.ownerDocument || e) !== M) A(e);
                if (!L) t = t.toLowerCase();
                if (n = C.attrHandle[t]) return n(e);
                if (L || $.attributes) return e.getAttribute(t);
                ...
                filter: {
                    ...
                    CLASS: function(e) {
                        var t = Y[e + " "];
                        return t || (t = new RegExp("(^|" + et + ")" + e + "(" + et + "|$)")) && Y(e, function(e) {
    ...
    lt.fn.extend({
        ...
        is: function(e) {
            return !!e && ("string" == typeof e ? Yt.test(e) ? lt(e, this.context).index(this[0]) >= 0 : lt.filter(e, this).length > 0 : this.filter(e).length > 0)
        },
        closest: function(e, t) {
            for (var n, i = 0, r = this.length, o = [], s = Yt.test(e) || "string" != typeof e ? lt(e, t || this.context) : 0; r > i; i++)
        ...
        lt.fn[e] = function(n, i) {
            ...
            if (r = this.length > 1 && !zt[e] ? lt.unique(r) : r, this.length > 1 && Bt.test(e)) r = r.reverse();
    ...
    if (lt.each(["height", "width"], function(e, t) {
            lt.cssHooks[t] = {
                ...
                set: function(e, n, i) {
                    var r = i && cn(e);
                    return C(e, n, i ? _(e, t, i, lt.support.boxSizing && "border-box" === lt.css(e, "boxSizing", !1, r), r) : 0)
                }
            }
    ...
    try {
        ...
        jn = X.createElement("a"), jn.href = "", jn = jn.href
    }
    Mn = $n.exec(jn.toLowerCase()) || [], lt.fn.load = function(e, n, i) {
        ...
        ajax: function(e, n) {
            function i(e, n, i, r) {
                ...
                if (2 !== x) {
                    ...
                    if (f = t, a = r || "", T.readyState = e > 0 ? 4 : 0, i) b = L(p, T, i);
                    if (e >= 200 && 300 > e || 304 === e) {
                        ...
                        else o = O(p, b), E = o.state, c = o.data, v = o.error, o = !v
                    } else if (v = E, e || !E)
                        if (E = "error", 0 > e) e = 0;
            ...
            if (m.promise(T).complete = g.add, T.success = T.done, T.error = T.fail, p.url = ((e || p.url || jn) + "").replace(Rn, "").replace(Fn, Mn[1] + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = lt.trim(p.dataType || "*").toLowerCase().match(ft) || [""], null == p.crossDomain) r = $n.exec(p.url.toLowerCase()), p.crossDomain = !(!r || r[1] === Mn[1] && r[2] === Mn[2] && (r[3] || ("http:" === r[1] ? 80 : 443)) == (Mn[3] || ("http:" === Mn[1] ? 80 : 443)));
            if (p.data && p.processData && "string" != typeof p.data) p.data = lt.param(p.data, p.traditional);
            if (M(Wn, p, n, T), 2 === x) return T;
            ...
            if (p.type = p.type.toUpperCase(), p.hasContent = !Pn.test(p.type), s = p.url, !p.hasContent) {
                if (p.data) s = p.url += (On.test(s) ? "&" : "?") + p.data, delete p.data;
                if (p.cache === !1) p.url = Hn.test(s) ? s.replace(Hn, "$1_=" + Ln++) : s + (On.test(s) ? "&" : "?") + "_=" + Ln++
            }
            if (p.ifModified) {
            ...
            if (f = M(Yn, p, n, T), !f) i(-1, "No Transport");
            else {
    ...
    lt.ajaxSetup({
        ...
        if (l || "jsonp" === n.dataTypes[0]) {
            ...
            else if (n.jsonp !== !1) n.url += (On.test(n.url) ? "&" : "?") + n.jsonp + "=" + o;
    ...
    function(e) {
        ...
        function c(e, t, n) {
            var i, r = [],
                ...
                p = "",
                d = "";
            if (n) a = "ts(", l = ")", p = L, d = O, i = o.defaultFilter;
        ...
        var D = 178245,
            ...
            O = ";",
            R = "return r;";
        if ("undefined" != typeof navigator && /msie\s*([0-9]+)/i.test(navigator.userAgent) && RegExp.$1 - 0 < 8) j = "var r=[],ri=0;", L = "r[ri++]=", R = 'return r.join("");';
        p.prototype = {
        ...
        var H = 'data=data||{};var v={},fs=engine.filters,hg=typeof data.get=="function",gv=function(n,ps){var p=ps[0],d=v[p];if(d==null){if(hg){return data.get(n);}d=data[p];}for(var i=1,l=ps.length;i<l;i++)if(d!=null)d = d[ps[i]];return d;},ts=function(s){if(typeof s==="string"){return s;}if(s==null){s="";}return ""+s;};';
        ...
        y.prototype.applyMaster = m.prototype.applyMaster = function(e) {
            ...
            if (this.isReady()) {
                var e = new Function("data", "engine", [H, j, this.getRendererBody(), R].join("\n")),
                    t = this.engine;
            ...
            h(e), d.prototype.open.call(this, e), this.state = I.READING, _(this, e)
            ...
            return l("{0}engine.render({2},{{3}}){1}", L, O, s(this.name), c(this.args, this.engine).replace(/(^|,)\s*([a-z0-9_]+)\s*=/gi, function(e, t, n) {
                return (t || "") + s(n) + ":"
            }))
            ...
            var e = this.args;
            return l("{2}fs[{5}]((function(){{0}{4}{1}})(){6}){3}", j, R, L, O, d.prototype.getRendererBody.call(this), s(this.name), e ? "," + c(e, this.engine) : "")
        };
        var q = {};
        k("target", m), k("block", g), k("import", y), k("use", x), k("var", v), k("for", w), k("if", T), k("elif", E), k("else", C), k("filter", b), N.prototype.config = function(e) {
            t(this.options, e)
        }, N.prototype.compile = N.prototype.parse = function(e) {
            if (e) {
                var t = S(e, this);
                if (t.length) return this.targets[t[0]].getRenderer()
            }
            return new Function('return ""')
        }, N.prototype.getRenderer = function(e) {
        ...
        }, N.prototype.addFilter = function(e, t) {
            if ("function" == typeof t) this.filters[e] = t
        };
        var P = new N;
        if (P.Engine = N, "object" == typeof exports && "object" == typeof module) exports = module.exports = P;
        else if ("function" == typeof define && define.amd) define("etpl/main", [], P);
        else e.etpl = P
    }(this), define("etpl", ["etpl/main"], function(e) {
        return e
    }), define("my/reward/list.tpl", [], function() {
        return '<!--* @ignore* @file list* @author fanyy* @time 15-4-12--><!-- target: returnTicketList --><!-- for: ${list} as ${item} --><div class="reward-ticket fl status${item.status}" ticketid="${item.ticketid}"><span class="ticket-name fl"><!-- if: ${item.ticket_type} == 1 -->现金券<!-- /if --></span><span class="ticket-amount fl"><label>${item.amount}</label>元<span class="ticket-src">来源：${item.src}<br/>有效期至：${item.valid_time}</span></span><span class="ticket-status ticket-status${item.status}"></span><!-- if: ${item.status} != 2 --><div class="ticket-status-tips fl"><table ><tr><td><!-- if: ${item.status} == 1 -->${item.desc}<!-- /if --><!-- if: ${item.status} == 3 -->兑换时间：${item.pay_time}<!-- /if --><!-- if: ${item.status} == 4 -->过期时间：${item.valid_time}<!-- /if --></td></tr></table></div><!-- /if --></div><!-- /for --><!-- /target -->'
        ...
        (function(e) {
            ...
            function M(e) {
                ...
                for (; o < e.length;) {
                    for (r = N(e[o]).split("-"), t = r.length, i = N(e[o + 1]), i = i ? i.split("-") : null; t > 0;) {
            ...
            function H(e, t) {
                ...
                switch (e) {
                    ...
                    case "Do":
                        return Pt;
                    default:
                        return n = new RegExp(z(Y(e.replace("\\", "")), "i"))
                }
            }
            ...
            function q(e, t, n) {
                ...
                switch (e) {
                    ...
                    case "MMM":
                    case "MMMM":
                        if (i = M(n._l).monthsParse(t), null != i) r[gt] = i;
                    ...
                    case "ddd":
                    case "dddd":
                        if (i = M(n._l).weekdaysParse(t), null != i) n._w = n._w || {}, n._w.d = i;
            ...
            function P(e) {
                ...
                else if (u = M(e._l), s = u._week.dow, a = u._week.doy, i = t(n.gg, e._a[mt], tt(ct(), s, a).year), r = t(n.w, 1), null != n.d) {
                    if (o = n.d, s > o) ++r
            ...
            function W(e) {
                ...
                e._a = [], e._pf.empty = !0;
                var t, n, i, r, o, s = M(e._l),
                    a = "" + e._i,
                    l = a.length,
                    u = 0;
                for (i = R(e._f, s).match(St) || [], t = 0; t < i.length; t++) {
                    if (r = i[t], n = (a.match(H(r, e)) || [])[0]) {
            ...
            function U(e) {
                ...
                for (o = 0; o < e._f.length; o++)
                    if (s = 0, t = u({}, e), t._pf = n(), t._f = e._f[o], W(t), k(t)) {
            ...
            function it(t) {
                ...
                if ("string" == typeof n) t._i = n = M().preparse(n);
            ...
            for (var ct, pt, dt = "2.7.0", ht = ("undefined" != typeof global ? global : this, Math.round), mt = 0, gt = 1, yt = 2, vt = 3, bt = 4, xt = 5, wt = 6, Tt = {}, Et = {
                    ...
                    _pf: null,
                    _lang: null
                }, Ct = "undefined" != typeof module && module.exports, _t = /^\/?Date\((\-?\d+)/i, kt = /(\-)?(?:(\d*)\.)?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?)?/, Nt = /^(-)?P(?:(?:([0-9,.]*)Y)?(?:([0-9,.]*)M)?(?:([0-9,.]*)D)?(?:T(?:([0-9,.]*)H)?(?:([0-9,.]*)M)?(?:([0-9,.]*)S)?)?|([0-9,.]*)W)$/, St = /(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Q|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|S{1,4}|X|zz?|ZZ?|.)/g, Dt = /(\[[^\[]*\])|(\\)?(LT|LL?L?L?|l{1,4})/g, At = /\d\d?/, Mt = /\d{1,3}/, jt = /\d{1,4}/, Lt = /[+\-]?\d{1,6}/, Ot = /\d+/, Rt = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i, Ht = /Z|[\+\-]\d\d:?\d\d/gi, It = /T/i, qt = /[\+\-]?\d+(\.\d{1,3})?/, Pt = /\d{1,2}/, Ft = /\d/, $t = /\d\d/, Bt = /\d{3}/, Wt = /\d{4}/, Yt = /[+-]?\d{6}/, zt = /[+-]?\d+/, Ut = /^\s*(?:[+-]\d{6}|\d{4})-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/, Gt = "YYYY-MM-DDTHH:mm:ssZ", Xt = [
            ...
            for (on.DDDD = r(on.DDD, 3), u(s.prototype, {
                    ...
                    else if (s = kt.exec(e)) n = "-" === s[1] ? -1 : 1, o = {
                        y: 0,
                        d: x(s[yt]) * n,
                        h: x(s[vt]) * n,
                        m: x(s[bt]) * n,
                    ...
                    else if (s = Nt.exec(e)) n = "-" === s[1] ? -1 : 1, r = function(e) {
                    ...
                    return n = ct.duration.fn._lang = ct.fn._lang = M(e), n._abbr
            ...
            ct.normalizeUnits = function(e) {
                ...
                toISOString: function() {
                    var e = ct(this).utc();
                    if (0 < e.year() && e.year() <= 9999) return O(e, "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]");
                    else return O(e, "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]")
                },
                toArray: function() {
                    var e = this;
                ...
                format: function(e) {
                    var t = O(this, e || ct.defaultFormat);
                ...
                lang: function(t) {
                    ...
                    else return this._lang = M(t), this
                }
    ...
    function(e) {
        ...
        var e = "" + window.location.protocol + "//" + window.location.host,
            t = {
                ...
                ACCOUNT_REWARD_TICKETS: e + "/account/awardapi/tickets",
                ACCOUNT_REWARD_TICKETS_EXCHANGE: e + "/account/awardapi/exchange"
            };
        return {
            URL: t
        }
    ...
    }), define("my/reward/index", ["require", "jquery", "etpl", "./list.tpl", "common/ui/Pager/Pager", "moment", "common/data", "common/header", "common/Remoter"], function(require) {
        function e() {
            a = l("#my-reward-list"), h.init(), u.compile(f), g.remote({
                page: 1
            }), n(), t()
        }

        function t() {
            l(".my-reward-tab-item").click(function() {
                if (!l(this).hasClass("current")) l(".my-reward-tab-item").removeClass("current"), l(this).addClass("current"), v = +l.trim(l(this).attr("data-value")), i(1)
            })
        }
        ...
        function n() {
            g.on("success", function(e) {
                if (e.bizError) o(e);
                    ...
                    if (!e.list.length) return s = null, l("#my-reward-pager").html(""), void a.html(u.render("Error", {
                        msg: "您当前没有奖券哟"
                    }));
                    if (!s) s = new c(l.extend({}, d.pagerOpt, {
                        main: l("#my-reward-pager"),
                        total: +e.pageall
                    })), s.on("change", function(e) {
                        i(e.value)
                    });
                    s.render(+e.page), r("returnTicketList", e), l("#my-reward-list .status2").click(function() {
                        y.remote({
                            ticketid: l(this).attr("ticketid")
                        })
                    }), l("#my-reward-list .reward-ticket").mouseenter(function() {
                        l(this).find(".ticket-status-tips").slideDown()
                    }).mouseleave(function() {
                        l(this).find(".ticket-status-tips").slideUp()
                    })
                }
            }), y.on("success", function(e) {
                if (e.bizError) l(".my-reward-tip").addClass("my-reward-tip-error"), l(".my-reward-tip").html(e.statusInfo);
                else l(".my-reward-tip").addClass("my-reward-tip-success"), l(".my-reward-tip").html(e.msg);
                l(".my-reward-tip").slideDown(), l(".close-reward-tip").click(function() {
                    l(".my-reward-tip").slideUp()
                })
            })
        }

        function i(e) {
            a.html(u.render("Loading")), l("#my-reward-pager").html(""), g.remote({
                page: e,
                status: v
            })
        }
        ...
        function r(e, t) {
            s.setOpt("pageall", +t.pageall), s.render(+t.page);
            for (var n = 0, i = t.list.length; i > n; n++) {
                if (t.list[n].valid_time = p.unix(t.list[n].valid_time).format(b), t.list[n].pay_time) t.list[n].pay_time = p.unix(t.list[n].pay_time).format(b);
                if (t.list[n].pass_time) t.list[n].pass_time = p.unix(t.list[n].pass_time).format(b)
            }
            a.html(u.render(e, {
                list: t.list
            }))
        ...
        function o(e) {
            a.render(u.render("Error", {
                msg: e.statusInfo
            }))
        }
        var s, a, l = require("jquery"),
            u = require("etpl"),
            f = require("./list.tpl"),
            c = require("common/ui/Pager/Pager"),
            p = require("moment"),
            d = require("common/data"),
            h = require("common/header"),
            m = require("common/Remoter"),
            g = new m("ACCOUNT_REWARD_TICKETS"),
            y = new m("ACCOUNT_REWARD_TICKETS_EXCHANGE"),
            v = 1,
            b = "YYYY.MM.DD";
        return {
            init: e
