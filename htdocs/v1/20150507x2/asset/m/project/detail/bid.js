! function(e, t) {
    ...
    function S(e) {
        var t = G,
            n = wn[e];
        if (!n) {
            if (n = _(e, t), "none" === n || !n) fn = (fn || lt("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement), t = (fn[0].contentWindow || fn[0].contentDocument).document, t.write("<!doctype html><html><body>"), t.close(), n = _(e, t), fn.detach();
            wn[e] = n
        }
        return n
    }
    ...
    function P(e, t, n) {
        var i, r, o = 0,
            ...
            l = function() {
                if (r) return !1;
                for (var t = Zn || I(), n = Math.max(0, u.startTime + u.duration - t), i = n / u.duration || 0, o = 1 - i, s = 0, l = u.tweens.length; l > s; s++) u.tweens[s].run(o);
    ...
    var Y, U, X = typeof t,
        ...
        wt = function(e) {
            if (G.addEventListener || "load" === e.type || "complete" === G.readyState) Tt(), lt.ready()
        },
        Tt = function() {
            if (G.addEventListener) G.removeEventListener("DOMContentLoaded", wt, !1), e.removeEventListener("load", wt, !1);
            else G.detachEvent("onreadystatechange", wt), e.detachEvent("onload", wt)
        };
    lt.fn = lt.prototype = {
        jquery: et,
        constructor: lt,
        init: function(e, n, i) {
            ...
            if ("string" == typeof e) {
                ...
                if (r && (r[1] || !n))
                    if (r[1]) {
                        if (n = n instanceof lt ? n[0] : n, lt.merge(this, lt.parseHTML(r[1], n && n.nodeType ? n.ownerDocument || n : G, !0)), dt.test(r[1]) && lt.isPlainObject(n))
                            for (r in n)
        ...
        ready: function(e) {
            if (e === !0 ? !--lt.readyWait : !lt.isReady) {
                ...
                if (lt.isReady = !0, !(e !== !0 && --lt.readyWait > 0))
                    if (Y.resolveWith(G, [lt]), lt.fn.trigger) lt(G).trigger("ready").off("ready")
            }
        },
        ...
        if (!Y)
            if (Y = lt.Deferred(), "complete" === G.readyState) setTimeout(lt.ready);
    ...
    lt.Callbacks = function(e) {
        ...
        var t, n, i, r, o, s, a, l, u, f, c = G.createElement("div");
        ...
        o = G.createElement("select"), a = o.appendChild(G.createElement("option")), r = c.getElementsByTagName("input")[0], i.style.cssText = "top:1px;float:left;opacity:.5", t = {
        ...
        if (r = G.createElement("input"), r.setAttribute("value", ""), t.input = "" === r.getAttribute("value"), r.value = "t", r.setAttribute("type", "radio"), t.radioValue = "t" === r.value, r.setAttribute("checked", "t"), r.setAttribute("name", "t"), s = G.createDocumentFragment(), s.appendChild(r), t.appendChecked = r.checked, t.checkClone = s.cloneNode(!0).cloneNode(!0).lastChild.checked, c.attachEvent) c.attachEvent("onclick", function() {
            t.noCloneEvent = !1
        }), c.cloneNode(!0).click();
        for (f in {
                submit: !0,
    ...
    if (lt.fn.extend({
                ...
                if (o && 1 === e.nodeType)
                    for (; n = o[r++];) {
                        if (i = lt.propFix[n] || n, Lt.test(n))
                            if (!Ht && Mt.test(n)) e[lt.camelCase("default-" + n)] = e[i] = !1;
                            else e[i] = !1;
                        else lt.attr(e, n, "");
            ...
            get: function(e, n) {
                var i = lt.prop(e, n),
                    ...
                    o = "boolean" == typeof i ? Rt && Ht ? null != r : Mt.test(n) ? e[lt.camelCase("default-" + n)] : !!r : e.getAttributeNode(n);
                return o && o.value !== !1 ? n.toLowerCase() : t
            },
            set: function(e, t, n) {
                if (t === !1) lt.removeAttr(e, n);
                else if (Rt && Ht || !Mt.test(n)) e.setAttribute(!Ht && lt.propFix[n] || n, n);
                else e[lt.camelCase("default-" + n)] = e[n] = !0;
                return n
            }
        }, !Rt || !Ht) lt.attrHooks.value = {
        get: function(e, n) {
    ...
    if (lt.event = {
                    ...
                    if (!Pt.test(h + lt.event.triggered)) {
                        ...
                        if (i = null == i ? [n] : lt.makeArray(i, [n]), f = lt.event.special[h] || {}, o || !f.trigger || f.trigger.apply(r, i) !== !1) {
                            if (!o && !f.noBubble && !lt.isWindow(r)) {
                                ...
                                if (c === (r.ownerDocument || G)) d.push(c.defaultView || c.parentWindow || e)
                            }
                            for (p = 0;
            ...
            fix: function(e) {
                ...
                if (!e.target) e.target = o.srcElement || G;
            ...
            mouseHooks: {
                ...
                filter: function(e, n) {
                    var i, r, o, s = n.button,
                        a = n.fromElement;
                    if (null == e.pageX && null != n.clientX) r = e.target.ownerDocument || G, o = r.documentElement, i = r.body, e.pageX = n.clientX + (o && o.scrollLeft || i && i.scrollLeft || 0) - (o && o.clientLeft || i && i.clientLeft || 0), e.pageY = n.clientY + (o && o.scrollTop || i && i.scrollTop || 0) - (o && o.clientTop || i && i.clientTop || 0);
        ...
        }, lt.removeEvent = G.removeEventListener ? function(e, t, n) {
    ...
    if (!lt.support.focusinBubbles) lt.each({
        ...
        lt.event.special[t] = {
            setup: function() {
                if (0 === n++) G.addEventListener(e, i, !0)
            },
            teardown: function() {
                if (0 === --n) G.removeEventListener(e, i, !0)
            }
        }
    });
    lt.fn.extend({
        ...
        function(e, t) {
            ...
            function s(e, t, n, i) {
                ...
                if (!M && !i) {
                    ...
                    else if ((s = r[3]) && B.getByClassName && t.getElementsByClassName) return J.apply(n, Q.call(t.getElementsByClassName(s), 0)), n;
                    if (B.qsa && !H.test(e)) {
                ...
                var n = 0,
                    ...
                    a = function(r, a, l, u, f) {
                        ...
                        if (g += y, i && y !== g) {
                            ...
                            if (J.apply(u, h), x && !r && h.length > 0 && g + t.length > 1) s.uniqueSort(u)
                        }
                        if (x) $ = T, D = b;
                        return v
                    };
            ...
            function b(e, t, n, i) {
                ...
                return S(e, u)(i, t, M, n, dt.test(e)), n
            }

            function w() {}
            var T, E, C, N, k, S, _, D, A, j, L, M, H, R, O, I, q, P = "sizzle" + -new Date,
                F = e.document,
                B = {},
                $ = 0,
                W = 0,
            ...
            k = s.isXML = function(e) {
                ...
                if (j = i, L = i.documentElement, M = k(i), B.tagNameNoComments = o(function(e) {
                        ...
                        return B.getIdNotName = !i.getElementById(P), L.removeChild(e), t
                ...
                if (C.find.TAG = B.tagNameNoComments ? function(e, t) {
                    ...
                    }, R = [], H = [":focus"], B.qsa = n(i.querySelectorAll)) o(function(e) {
                ...
                if (B.matchesSelector = n(O = L.matchesSelector || L.mozMatchesSelector || L.webkitMatchesSelector || L.oMatchesSelector || L.msMatchesSelector)) o(function(e) {
                    B.disconnectedMatch = O.call(e, "div"), O.call(e, "[s!='']:x"), R.push("!=", ot)
                });
                return H = new RegExp(H.join("|")), R = new RegExp(R.join("|")), I = n(L.contains) || L.compareDocumentPosition ? function(e, t) {
                ...
                }, _ = !1, [0, 0].sort(q), B.detectDuplicates = _, j
            }, s.matches = function(e, t) {
                return s(e, null, null, t)
            }, s.matchesSelector = function(e, t) {
                if ((e.ownerDocument || e) !== j) A(e);
                if (t = t.replace(xt, "='$1']"), !(!B.matchesSelector || M || R && R.test(t) || H.test(t))) try {
                    var n = O.call(e, t);
                ...
                if (M || B.attributes) return e.getAttribute(t);
                ...
                var t, n = [],
                    i = 1,
                    r = 0;
                if (_ = !B.detectDuplicates, e.sort(q), _) {
                    for (; t = e[i]; i++)
                        ...
                        return 1 === i && 0 === r ? function(e) {
                            ...
                            if (g) {
                                ...
                                if (h = [s ? g.firstChild : g.lastChild], s && v) {
                                    for (f = g[P] || (g[P] = {}), u = f[e] || [], d = u[0] === $ && u[1], p = u[0] === $ && u[2], c = d && g.childNodes[d]; c = ++d && c && c[m] || (p = d = 0) || h.pop();)
    ...
    lt.fn.extend({
        ...
        lt.fn[e] = function(n, i) {
            ...
            if (r = this.length > 1 && !Yt[e] ? lt.unique(r) : r, this.length > 1 && $t.test(e)) r = r.reverse();
    ...
    an.optgroup = an.option, an.tbody = an.tfoot = an.colgroup = an.caption = an.thead, an.th = an.td, lt.fn.extend({
        ...
        remove: function(e, t) {
            for (var n, i = 0; null != (n = this[i]); i++)
                if (!e || lt.filter(e, [n]).length > 0) {
                    ...
                    if (n.parentNode) {
                        if (t && lt.contains(n.ownerDocument, n)) g(x(n, "script"));
        ...
        html: function(e) {
            return lt.access(this, function(e) {
                ...
                if (!("string" != typeof e || en.test(e) || !lt.support.htmlSerialize && Gt.test(e) || !lt.support.leadingWhitespace && Vt.test(e) || an[(Jt.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(Kt, "<$1></$2>");
                    try {
                        for (; r > i; i++)
        ...
        clone: function(e, t, n) {
            ...
            if (lt.support.html5Clone || lt.isXMLDoc(e) || !Gt.test("<" + e.nodeName + ">")) o = e.cloneNode(!0);
            ...
            if (i = x(o, "script"), i.length > 0) g(i, !l && x(e, "script"));
            return i = a = r = null, o
        },
        buildFragment: function(e, t, n, i) {
            ...
            for (m = 0; o = h[m++];)
                if (!i || -1 === lt.inArray(o, i)) {
                    if (s = lt.contains(o.ownerDocument, o), a = x(d.appendChild(o), "script"), s) g(a);
                    if (n)
                        for (r = 0; o = a[r++];)
    ...
    else if (G.documentElement.currentStyle) cn = function(e) {
    ...
    jn = Bn.exec(Ln.toLowerCase()) || [], lt.fn.load = function(e, n, i) {
        ...
        ajax: function(e, n) {
            function i(e, n, i, r) {
                ...
                if (2 !== b) {
                    ...
                    if (f = t, a = r || "", T.readyState = e > 0 ? 4 : 0, i) x = M(p, T, i);
                    if (e >= 200 && 300 > e || 304 === e) {
                        ...
                        else o = H(p, x), E = o.state, c = o.data, v = o.error, o = !v
                    } else if (v = E, e || !E)
                        if (E = "error", 0 > e) e = 0;
            ...
            if (m.promise(T).complete = g.add, T.success = T.done, T.error = T.fail, p.url = ((e || p.url || Ln) + "").replace(Rn, "").replace(Fn, jn[1] + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = lt.trim(p.dataType || "*").toLowerCase().match(ft) || [""], null == p.crossDomain) r = Bn.exec(p.url.toLowerCase()), p.crossDomain = !(!r || r[1] === jn[1] && r[2] === jn[2] && (r[3] || ("http:" === r[1] ? 80 : 443)) == (jn[3] || ("http:" === jn[1] ? 80 : 443)));
            ...
            if (p.type = p.type.toUpperCase(), p.hasContent = !Pn.test(p.type), s = p.url, !p.hasContent) {
                ...
                if (p.cache === !1) p.url = On.test(s) ? s.replace(On, "$1_=" + Mn++) : s + (Hn.test(s) ? "&" : "?") + "_=" + Mn++
            }
            if (p.ifModified) {
        ...
        if (e.crossDomain) {
            var n, i = G.head || lt("head")[0] || G.documentElement;
            return {
                send: function(t, r) {
                    if (n = G.createElement("script"), n.async = !0, e.scriptCharset) n.charset = e.scriptCharset;
    ...
    lt.ajaxSetup({
        ...
        if (l || "jsonp" === n.dataTypes[0]) {
            if (o = n.jsonpCallback = lt.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback, l) n[l] = n[l].replace(Gn, "$1" + o);
    ...
    if (lt.ajaxSettings.xhr = e.ActiveXObject ? function() {
            return !this.isLocal && R() || O()
        } : R, Kn = lt.ajaxSettings.xhr(), lt.support.cors = !!Kn && "withCredentials" in Kn, Kn = lt.support.ajax = !!Kn) lt.ajaxTransport(function(n) {
    ...
    if (lt.fn.offset = function(e) {
        ...
        return e
    }), define("m/common/common.tpl", [], function() {
        return '<!--* @ignore* @file error.tpl* @author fanyy** @time 15-4-28--><!-- target: Loading --><div class="xjd-loading">&nbsp;</div><!-- /target --><!-- target: Error --><div class="xjd-error"><div class="xjd-error-msg">${msg}</div></div><!-- /target -->'
    }),
    function(e) {
        function t(e, t) {
            for (var n in t)
        ...
        function c(e, t, n) {
            var i, r = [],
                ...
                p = "",
                d = "";
            if (n) a = "ts(", l = ")", p = M, d = H, i = o.defaultFilter;
        ...
        var D = 178245,
            ...
            H = ";",
            R = "return r;";
        if ("undefined" != typeof navigator && /msie\s*([0-9]+)/i.test(navigator.userAgent) && RegExp.$1 - 0 < 8) L = "var r=[],ri=0;", M = "r[ri++]=", R = 'return r.join("");';
        p.prototype = {
        ...
        r(m, d), r(g, d), r(y, d), r(v, d), r(x, d), r(b, d), r(w, d), r(T, d), r(E, T), r(C, T);
        var I = {
            READING: 1,
            READED: 2,
            APPLIED: 3,
        ...
        y.prototype.applyMaster = m.prototype.applyMaster = function(e) {
            ...
            if (this.isReady()) {
                var e = new Function("data", "engine", [O, L, this.getRendererBody(), R].join("\n")),
                    t = this.engine;
        ...
        }, b.prototype.beforeOpen = y.prototype.beforeOpen = v.prototype.beforeOpen = w.prototype.beforeOpen = x.prototype.beforeOpen = g.prototype.beforeOpen = T.prototype.beforeOpen = p.prototype.beforeAdd = function(e) {
            if (!e.stack.bottom()) {
            ...
            return l("{0}engine.render({2},{{3}}){1}", M, H, s(this.name), c(this.args, this.engine).replace(/(^|,)\s*([a-z0-9_]+)\s*=/gi, function(e, t, n) {
                return (t || "") + s(n) + ":"
            }))
            ...
            var e = this.args;
            return l("{2}fs[{5}]((function(){{0}{4}{1}})(){6}){3}", L, R, M, H, d.prototype.getRendererBody.call(this), s(this.name), e ? "," + c(e, this.engine) : "")
        };
        var q = {};
        k("target", m), k("block", g), k("import", y), k("use", b), k("var", v), k("for", w), k("if", T), k("elif", E), k("else", C), k("filter", x), S.prototype.config = function(e) {
            t(this.options, e)
    ...
    function() {
        ...
        function e(t, i) {
            ...
            if (i = i || {}, this.trackingClick = !1, this.trackingClickStart = 0, this.targetElement = null, this.touchStartX = 0, this.touchStartY = 0, this.lastTouchIdentifier = 0, this.touchBoundary = i.touchBoundary || 10, this.layer = t, this.tapDelay = i.tapDelay || 200, this.tapTimeout = i.tapTimeout || 700, !e.notNeeded(t)) {
                ...
                if (n) t.addEventListener("mouseover", this.onMouse, !0), t.addEventListener("mousedown", this.onMouse, !0), t.addEventListener("mouseup", this.onMouse, !0);
                if (t.addEventListener("click", this.onClick, !0), t.addEventListener("touchstart", this.onTouchStart, !1), t.addEventListener("touchmove", this.onTouchMove, !1), t.addEventListener("touchend", this.onTouchEnd, !1), t.addEventListener("touchcancel", this.onTouchCancel, !1), !Event.prototype.stopImmediatePropagation) t.removeEventListener = function(e, n, i) {
                    var r = Node.prototype.removeEventListener;
                    if ("click" === e) r.call(t, e, n.hijacked || n, i);
                    else r.call(t, e, n, i)
                }, t.addEventListener = function(e, n, i) {
                    var r = Node.prototype.addEventListener;
                    if ("click" === e) r.call(t, e, n.hijacked || (n.hijacked = function(e) {
                        if (!e.propagationStopped) n(e)
                    }), i);
                    else r.call(t, e, n, i)
                };
                if ("function" == typeof t.onclick) o = t.onclick, t.addEventListener("click", function(e) {
                    o(e)
                }, !1), t.onclick = null
            }
        }
        ...
        if (e.prototype.needsClick = function(e) {
                ...
                var n, i;
                if (document.activeElement && document.activeElement !== e) document.activeElement.blur();
                i = t.changedTouches[0], n = document.createEvent("MouseEvents"), n.initMouseEvent(this.determineEventType(e), !0, !0, window, 1, i.screenX, i.screenY, i.clientX, i.clientY, !1, !1, !1, !1, 0, null), n.forwardedTouchEvent = !0, e.dispatchEvent(n)
            }, e.prototype.determineEventType = function(e) {
                if (n && "select" === e.tagName.toLowerCase()) return "mousedown";
                else return "click"
            }, e.prototype.focus = function(e) {
                var t;
                if (i && e.setSelectionRange && 0 !== e.type.indexOf("date") && "time" !== e.type && "month" !== e.type) t = e.value.length, e.setSelectionRange(t, t);
                else e.focus()
                ...
                if (t) t.fastClickLastScrollTop = t.scrollTop
                ...
                if (this.trackingClick = !0, this.trackingClickStart = e.timeStamp, this.targetElement = t, this.touchStartX = n.pageX, this.touchStartY = n.pageY, e.timeStamp - this.lastClickTime < this.tapDelay) e.preventDefault();
                return !0
            }, e.prototype.touchHasMoved = function(e) {
                var t = e.changedTouches[0],
                    n = this.touchBoundary;
                if (Math.abs(t.pageX - this.touchStartX) > n || Math.abs(t.pageY - this.touchStartY) > n) return !0;
                else return !1
                ...
                else return e.querySelector("button, input:not([type=hidden]), keygen, meter, output, progress, select, textarea")
            }, e.prototype.onTouchEnd = function(e) {
                var t, s, a, l, u, f = this.targetElement;
                if (!this.trackingClick) return !0;
                if (e.timeStamp - this.lastClickTime < this.tapDelay) return this.cancelNextClick = !0, !0;
                if (e.timeStamp - this.trackingClickStart > this.tapTimeout) return !0;
                if (this.cancelNextClick = !1, this.lastClickTime = e.timeStamp, s = this.trackingClickStart, this.trackingClick = !1, this.trackingClickStart = 0, o) u = e.changedTouches[0], f = document.elementFromPoint(u.pageX - window.pageXOffset, u.pageY - window.pageYOffset) || f, f.fastClickScrollParent = this.targetElement.fastClickScrollParent;
                if (a = f.tagName.toLowerCase(), "label" === a) {
                    if (t = this.findControl(f)) {
                        if (this.focus(f), n) return !1;
                        f = t
                    }
                } else if (this.needsFocus(f)) {
                    if (e.timeStamp - s > 100 || i && window.top !== window && "input" === a) return this.targetElement = null, !1;
                    if (this.focus(f), this.sendClick(f, e), !i || "select" !== a) this.targetElement = null, e.preventDefault();
                    return !1
                }
                if (i && !r)
                    if (l = f.fastClickScrollParent, l && l.fastClickLastScrollTop !== l.scrollTop) return !0;
                if (!this.needsClick(f)) e.preventDefault(), this.sendClick(f, e);
                return !1
                ...
                if (t = this.onMouse(e), !t) this.targetElement = null;
                return t
            }, e.prototype.destroy = function() {
                var e = this.layer;
                if (n) e.removeEventListener("mouseover", this.onMouse, !0), e.removeEventListener("mousedown", this.onMouse, !0), e.removeEventListener("mouseup", this.onMouse, !0);
                e.removeEventListener("click", this.onClick, !0), e.removeEventListener("touchstart", this.onTouchStart, !1), e.removeEventListener("touchmove", this.onTouchMove, !1), e.removeEventListener("touchend", this.onTouchEnd, !1), e.removeEventListener("touchcancel", this.onTouchCancel, !1)
                ...
                if (s)
                    if (r = navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/), r[1] >= 10 && r[2] >= 3)
                        if (t = document.querySelector("meta[name=viewport]")) {
                            if (-1 !== t.content.indexOf("user-scalable=no")) return !0;
                            if (document.documentElement.scrollWidth <= window.outerWidth) return !0
                        }
                if ("none" === e.style.msTouchAction || "manipulation" === e.style.touchAction) return !0;
                if (o = +(/Firefox\/([0-9]+)/.exec(navigator.userAgent) || [, 0])[1], o >= 27)
                    if (t = document.querySelector("meta[name=viewport]"), t && (-1 !== t.content.indexOf("user-scalable=no") || document.documentElement.scrollWidth <= window.outerWidth)) return !0;
                if ("none" === e.style.touchAction || "manipulation" === e.style.touchAction) return !0;
                else return !1
            }, e.attach = function(t, n) {
                return new e(t, n)
            }, "function" == typeof define && "object" == typeof define.amd && define.amd) define("m/common/fastclick", [], function() {
            return e
        });
        else if ("undefined" != typeof module && module.exports) module.exports = e.attach, module.exports.FastClick = e;
        else window.FastClick = e
    }(), define("m/common/common", ["require", "./common.tpl", "etpl", "m/common/fastclick"], function(require) {
        function e() {
            i.compile(n), r.attach(document.body)
        }

        function t(e, t, n) {
            var i = document.getElementById("pullDown"),
                r = i.offsetHeight,
                o = document.getElementById("pullUp"),
                s = o.offsetHeight;
            e.on("scroll", function() {
                if (this.y > 5 && !i.className.match("flip")) i.className = "flip", i.querySelector(".pullDownLabel").innerHTML = "释放后加载最新", this.minScrollY = 0;
                else if (this.y < 5 && i.className.match("flip")) i.className = "", i.querySelector(".pullDownLabel").innerHTML = "下拉加载更多", this.minScrollY = -r;
                else if (this.y < this.maxScrollY - 5 && !o.className.match("flip")) o.className = "flip", o.querySelector(".pullUpLabel").innerHTML = "释放后加载最新", this.maxScrollY = this.maxScrollY;
                else if (this.y > this.maxScrollY + 5 && o.className.match("flip")) o.className = "", o.querySelector(".pullUpLabel").innerHTML = "上拉加载更多", this.maxScrollY = s
            }), e.on("scrollEnd", function() {
                if (i.className.match("flip")) i.className = "loading", i.querySelector(".pullDownLabel").innerHTML = "正在努力加载中...", n();
                else if (o.className.match("flip")) o.className = "loading", o.querySelector(".pullUpLabel").innerHTML = "正在努力加载中...", t()
            }), e.on("refresh", function() {
                if (i.className.match("loading")) i.className = "", i.querySelector(".pullDownLabel").innerHTML = "下拉加载更多";
                else if (o.className.match("loading")) o.className = "", o.querySelector(".pullUpLabel").innerHTML = "上拉加载更多"
            })
        }
        var n = require("./common.tpl"),
            i = require("etpl"),
            r = require("m/common/fastclick");
        return {
            init: e,
            myScrollEvents: t
        }
    ...
    }), define("m/project/detail/bid", ["require", "jquery", "m/common/common", "common/Remoter", "common/util"], function(require) {
        function e(e) {
            i.extend(s, e), s.amountRest = +e.amountRest.replace(",", ""), s.days = +e.days, s.userAmount = +e.userAmount.replace(",", ""), s.interest = +e.interest, t()
        }

        function t() {
            i(".confirm-submit").click(function() {
                i("#invest-form").trigger("submit")
            }), i(".confirm-all").click(function() {
                var e = i(".right-top-ipt-input");
                 var tip = i('.chongzhi-span');
                if (o.hasClass("show") && o.removeClass("show"), !e[0].disabled)  
                     {
                     	var value=Math.min(s.userAmount, s.amountRest);
			            e.val(value); 
			            tip.html(n(value || 0));
                     }  
            }), i(".detail-error-cha").click(function() {
                i(this).parent().remove()
            }), i("#invest-form").on("submit", function() {
                var e = i(".right-top-ipt-input"),
                    t = +i.trim(e.val());
                if (e[0].disabled) return !1;
                if (!t) return o.addClass("show").html("输入不能为空"), !1;
                if (isNaN(t)) return o.addClass("show").html("输入内容不合法"), !1;
                if (s.amountRest < 100 && t !== s.amountRest) return o.addClass("show").html("投标金额必须为" + s.amountRest + "元"), !1;
                if (t > s.userAmount) return o.addClass("show").html("可用余额不足"), !1;
                if (100 > t && t !== s.amountRest) return o.addClass("show").html("最小投标金额100元"), !1;
                if (t > s.amountRest) return o.addClass("show").html("可投金额不足"), !1;
                else return void 0
            }), i(".right-top-ipt-input").on({
                keyup: function() {
                    var e = +i.trim(i(this).val()),
                        t = i(".chongzhi-span");
                    if (isNaN(e)) return t.html("0.00"), void i(this).val(0);
                    var r = i(this).attr("max");
                    if (e > r) i(this).val(r);
                    t.html(n(+i.trim(i(this).val()) || 0))
                },
                blur: function() {}
            })
        }
        ...
        function n(e) {
            var t = e * s.interest / 100 * s.days / 365;
            return t = t.toFixed(2), r.addCommas(t)
        }
        var i = require("jquery"),
            r = (require("m/common/common"), require("common/Remoter"), require("common/util")),
            o = i("#chongzhi-error"),
            s = {};
        return {
            init: e
