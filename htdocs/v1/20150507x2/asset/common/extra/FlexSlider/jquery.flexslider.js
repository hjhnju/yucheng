define('common/extra/FlexSlider/jquery.flexslider', [
    ...
    $.flexslider = function (el, options) {
        ...
        var namespace = slider.vars.namespace, msGesture = window.navigator && window.navigator.msPointerEnabled && window.MSGesture, touch = ('ontouchstart' in window || msGesture || window.DocumentTouch && document instanceof DocumentTouch) && slider.vars.touch, directionNaveventType = 'click touchend MSPointerUp keyup', eventType = 'click touchend MSPointerUp keyup', watchedEvent = '', watchedEventClearTimer, vertical = slider.vars.direction === 'vertical', reverse = slider.vars.reverse, carousel = slider.vars.itemWidth > 0, fade = slider.vars.animation === 'fade', asNav = slider.vars.asNavFor !== '', methods = {}, focused = true;
